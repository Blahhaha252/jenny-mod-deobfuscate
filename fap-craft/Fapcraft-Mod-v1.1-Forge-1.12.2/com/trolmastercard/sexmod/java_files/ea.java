...
extends GuiScreen {
    ...
    public void func_73863_a(int n, int n2, float f) {
        ...
        float f6 = (float)this.a(this.a);
        float f7 = (1.0f - f6) * 100.0f;
        try {
            ea ea2 = this;
            ea ea3 = ea2;
            f5 = ea2.g;
            n6 = n < this.field_146294_l / 2 ? 1 : -1;
        }
        catch (NullPointerException nullPointerException) {
            throw ea.a(nullPointerException);
        }
        try {
            ea3.g = f5 + (float)n6 * this.field_146297_k.func_193989_ak();
            ea ea4 = this;
            ea ea5 = ea4;
            f4 = ea4.e;
            n5 = n > this.field_146294_l / 2 ? 1 : -1;
        }
        catch (NullPointerException nullPointerException) {
            throw ea.a(nullPointerException);
        }
        try {
            ea5.e = f4 + (float)n5 * this.field_146297_k.func_193989_ak();
            ea ea6 = this;
            ea ea7 = ea6;
            f3 = ea6.d;
            n4 = n2 < this.field_146295_m / 2 - 1 ? 1 : -1;
        }
        catch (NullPointerException nullPointerException) {
            throw ea.a(nullPointerException);
        }
        try {
            ea7.d = f3 + (float)n4 * this.field_146297_k.func_193989_ak();
            ea ea8 = this;
            ea ea9 = ea8;
            f2 = ea8.m;
            n3 = n2 > this.field_146295_m / 2 ? 1 : -1;
        }
        catch (NullPointerException nullPointerException) {
            throw ea.a(nullPointerException);
        }
        try {
            ea9.m = f2 + (float)n3 * this.field_146297_k.func_193989_ak();
            ...
            GlStateManager.func_179152_a((float)f6, (float)f6, (float)f6);
            ...
            this.func_175174_a(-62.0f + f7 - this.g * 15.0f, f7 - 32.0f, 0, 0, 64, 64);
            this.func_175174_a(-62.0f + f7 - this.g * 15.0f, f7 - 32.0f, 64, 128, 64, 64);
        ...
        try {
            ...
            this.func_175174_a(-2.0f - f7 + this.e * 32.0f, -f7 - 32.0f, 0, 0, 64, 64);
            this.func_175174_a(-2.0f - f7 + this.e * 32.0f, -f7 - 32.0f, 0, 128, 64, 64);
            GlStateManager.func_179121_F();
            if (this.e > 0.0f) {
                GlStateManager.func_179094_E();
                GlStateManager.func_179152_a((float)(-1.0f + this.e + 1.0f + this.d * 0.5f), (float)(-1.0f + this.e + 1.0f + this.d * 0.5f), (float)1.0f);
                this.func_175174_a(-2.0f - f7 + this.d * 5.0f, -f7 - 64.0f - this.d * 5.0f / 2.0f, 0, 0, 64, 64);
                this.func_175174_a(-2.0f - f7 + this.d * 5.0f, -f7 - 64.0f - this.d * 5.0f / 2.0f, 128, 128, 64, 64);
                GlStateManager.func_179121_F();
                GlStateManager.func_179094_E();
                GlStateManager.func_179152_a((float)(-1.0f + this.e + 1.0f + this.m * 0.5f), (float)(-1.0f + this.e + 1.0f + this.m * 0.5f), (float)1.0f);
                this.func_175174_a(-2.0f - f7 + this.m * 5.0f, -f7 + this.m * 5.0f / 2.0f, 0, 0, 64, 64);
                this.func_175174_a(-2.0f - f7 + this.m * 5.0f, -f7 + this.m * 5.0f / 2.0f, 192, 128, 64, 64);
                GlStateManager.func_179121_F();
            }
        }
        catch (NullPointerException nullPointerException) {
