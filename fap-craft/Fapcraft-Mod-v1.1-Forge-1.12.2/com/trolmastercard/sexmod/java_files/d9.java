    ...
    public void renderRecursively(BufferBuilder var1_1, GeoBone var2_2, float var3_3, float var4_4, float var5_5, float var6_6) {
                                            ...
                                            block66: {
                                                block76: {
                                                    block75: {
                                                        ...
                                                        try {
                                                            if (var7_7.equals("head")) {
                                                                this.a(var1_1, var2_2, Color.ofRGB((float)var3_3, (float)var4_4, (float)var5_5));
                                                            }
                                                        }
        ...
        if (!var2_2.isHidden) {
            ...
            if (!this.p.contains(var7_7)) {
                for (GeoCube var12_12 : var2_2.childCubes) {
                    d9.MATRIX_STACK.push();
                    GlStateManager.func_179094_E();
                    this.q = var2_2;
                    this.a(var1_1, var12_12, var2_2, var3_3, var4_4, var5_5, var6_6, var9_10);
                    GlStateManager.func_179121_F();
                    d9.MATRIX_STACK.pop();
                }
            }
            for (GeoCube var12_12 : var2_2.childBones) {
                try {
                    if (var9_10 == 0.0) {
