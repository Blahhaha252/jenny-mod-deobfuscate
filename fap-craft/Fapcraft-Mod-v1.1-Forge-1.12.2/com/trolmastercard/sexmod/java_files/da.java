...
implements c3 {
    ...
    static final ef.b G = new ef.b(H, 0.1f, 12, 0.035f, (n, f) -> (float)(Math.sin((double)f * 0.3 + -0.2 * (double)n) * 15.0), (n, f) -> (float)(Math.sin((double)f * -0.15 + -0.2 * (double)n) * 3.0), (n, f) -> 0.0f, 0.03f, 0.005f);
    static final ef.b t = new ef.b(H, 0.0f, 12, 0.0f, (n, f) -> (float)(Math.sin((double)f * 0.3 + -0.2 * (double)n) * 15.0), (n, f) -> (float)(Math.sin((double)f * -0.15 + -0.2 * (double)n) * 3.0), (n, f) -> 0.0f, 0.03f, 0.005f);
    boolean r = false;
    float s = 0.0f;
    ...
    protected void b(f_ f_2) {
        ...
        f_2.field_70177_z = f = f_2.I().floatValue();
        f_2.field_70760_ar = f;
        f_2.field_70761_aq = f;
        f_2.field_70758_at = f;
        f_2.field_70759_as = f;
    }
    ...
    void d(f_ f_2) {
        block8: {
            ...
            block7: {
                ...
                try {
                    bl = Math.abs(vec3d.field_72450_a) + Math.abs(vec3d.field_72449_c) < (double)0.05f;
                }
                catch (RuntimeException runtimeException) {
                    throw da.a(runtimeException);
                }
            ...
            f_2.field_70761_aq = f = (float)(gc.b(Math.atan2(vec3d.field_72449_c, vec3d.field_72450_a)) - 90.0);
            f_2.field_70760_ar = f;
            this.s = f;
        }
    }
    ...
    public static Vec3d a(f_ f_2, float f) {
        ...
        block12: {
            ...
            vec3d = b6.a(new Vec3d(entityLivingBase.field_70169_q, entityLivingBase.field_70167_r, entityLivingBase.field_70166_s), entityLivingBase.func_174791_d(), (double)f);
            try {
                try {
                    if (f3 != 24.0f || f_2.af != -1L) break block12;
                }
                catch (RuntimeException runtimeException) {
                    throw da.a(runtimeException);
                }
        ...
        if (be.a((double)f3, 24.0, 32.0)) {
            ...
            float f4 = ((float)da.i.field_71441_e.func_82737_E() + f - (float)f_2.af) / (float)(f_2.aH - f_2.af);
    ...
    public static void a(em em2, float f) {
        ...
        da.a(em2, bufferBuilder, tessellator, b6.a(em2.field_70760_ar, em2.field_70761_aq, f));
    ...
    static void b(em em2, BufferBuilder bufferBuilder, Tessellator tessellator, float f) {
        ...
        float f3 = (float)da.i.field_71441_e.func_82737_E() + f;
        ...
        GlStateManager.func_179114_b((float)f5, (float)0.0f, (float)0.0f, (float)1.0f);
        float f9 = gc.c(9.0);
        f7 f72 = f_.aa;
        i.func_110434_K().func_110577_a(e);
        bufferBuilder.func_181668_a(3, DefaultVertexFormats.field_181709_i);
        GlStateManager.func_187441_d((float)da.a(em2, f, 1.0f, 3.0f));
        float f10 = 0.0f;
        while ((double)f10 < Math.PI * 2) {
            d2 = Math.sin(f10) * (double)0.3f;
            d = Math.cos(f10) * (double)0.3f;
            bufferBuilder.func_181662_b(d2, 0.0, d).func_187315_a(0.0, 0.0).func_181666_a(f72.a, f72.c, f72.b, 1.0f).func_181675_d();
            f10 += f9;
        }
        ...
        while ((double)f10 < Math.PI * 2) {
            d2 = Math.sin(f10) * (double)0.3f;
            d = Math.cos(f10) * (double)0.3f;
            bufferBuilder.func_181662_b(d2 - (double)0.1f, (double)0.1f, d).func_187315_a(0.0, 0.0).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).func_181675_d();
            bufferBuilder.func_181662_b(d2 + (double)0.1f, (double)0.1f, d).func_187315_a(1.0, 0.0).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).func_181675_d();
            bufferBuilder.func_181662_b(d2 + (double)0.1f, (double)-0.1f, d).func_187315_a(1.0, 1.0).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).func_181675_d();
            bufferBuilder.func_181662_b(d2 - (double)0.1f, (double)-0.1f, d).func_187315_a(0.0, 1.0).func_181666_a(1.0f, 1.0f, 1.0f, 1.0f).func_181675_d();
            f10 += f9;
        }
        tessellator.func_78381_a();
        GlStateManager.func_179121_F();
    ...
    void c(BufferBuilder bufferBuilder, GeoBone geoBone) {
        ...
        try {
            f = ((f_)this.j).aD ? 1.0f - Math.min(0.29f, fp.a(this.j, i.func_184121_ak())) / 0.29f : 1.0f;
        }
        catch (RuntimeException runtimeException) {
            throw da.a(runtimeException);
        }
        float f3 = f;
        this.a(bufferBuilder, geoBone, f3);
    ...
    void d(GeoBone geoBone) {
        ...
        float f = (float)da.i.field_71439_g.field_70173_aa + i.func_184121_ak();
        ...
        float f5 = 1.0f - Math.min(0.5f, fp.a(this.j, i.func_184121_ak())) / 0.5f;
    ...
    void c(GeoBone geoBone) {
        ...
        float f5 = Math.min(0.5f, fp.a(this.j, i.func_184121_ak())) / 0.5f;
        geoBone.setRotationY(geoBone.getRotationY() + f3 * f5);
        geoBone.setRotationZ(geoBone.getRotationZ() + f4 * f5);
    }
    ...
    void a(BufferBuilder bufferBuilder, GeoBone geoBone, float f3) {
        float f5 = fp.d(this.j, i.func_184121_ak());
        float f6 = f3 * (float)((double)0.02f * ((double)-0.4f * Math.cos(Math.PI * 2 * (double)f5 + 1.05) + (double)0.6f));
        ef.b b2 = new ef.b(H, 0.0f, 12, f6, (n, f4) -> f3 * (float)(Math.cos(Math.PI * 2 * (double)f5 + (double)0.35f + (double)(-0.2f * (float)n)) * -10.0), (n, f) -> 0.0f, (n, f4) -> f3 * (float)(Math.cos(Math.PI * 2 * (double)f5 + 1.25 + (double)(-0.1f * (float)n)) * -5.0), 0.03f, 0.005f);
        this.a(bufferBuilder, geoBone, b2);
    }

    void d(BufferBuilder bufferBuilder, GeoBone geoBone) {
        float f4 = fp.d(this.j, i.func_184121_ak());
        ef.b b2 = new ef.b(H, 0.0f, 12, 0.02f, (n, f3) -> (float)(Math.cos(Math.PI * 2 * (double)f4 + (double)(-0.2f * (float)n)) * 15.0), (n, f3) -> (float)(Math.cos(Math.PI * 2 * (double)f4 + (double)(-0.2f * (float)n)) * 5.0), (n, f) -> 0.0f, 0.03f, 0.005f);
        this.a(bufferBuilder, geoBone, b2);
    }

    void f(BufferBuilder bufferBuilder, GeoBone geoBone) {
        float f = ((f_)this.j).b(i.func_184121_ak());
        try {
            if (f == 0.0f) {
    ...
    void a(BufferBuilder bufferBuilder, GeoBone geoBone, ef.b b2) {
        GlStateManager.func_179094_E();
        Tessellator.func_178181_a().func_78381_a();
        com.trolmastercard.sexmod.p.a(MATRIX_STACK, geoBone);
        GlStateManager.func_179129_p();
        this.func_110776_a(e);
        ef.a(bufferBuilder, Tessellator.func_178181_a(), i, b2);
    ...
    void a(BufferBuilder bufferBuilder, GeoBone geoBone, f_ f_2, float f) {
        ...
        OpenGlHelper.func_77475_a((int)OpenGlHelper.field_77476_b, (float)f5, (float)f5);
        MATRIX_STACK.push();
        ...
        OpenGlHelper.func_77475_a((int)OpenGlHelper.field_77476_b, (float)f6, (float)f9);
    }
    ...
    protected Vec3d a(f_ f_2, float f, Vec3d vec3d) {
        if (f_2.y() == fp.RUN) {
            float f3;
            f_2.field_70177_z = f3 = f_2.I().floatValue();
            f_2.field_70760_ar = f3;
            f_2.field_70761_aq = f3;
            f_2.field_70758_at = f3;
            f_2.field_70759_as = f3;
        }
        return vec3d;
    }
