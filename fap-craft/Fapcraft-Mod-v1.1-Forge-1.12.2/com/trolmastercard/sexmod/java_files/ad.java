...
public class ad {
    ...
    public void c(ClientChatEvent clientChatEvent) {
        ...
        Minecraft.func_71410_x().field_71439_g.func_145747_a((ITextComponent)new TextComponentString(String.format("%sSet dev float N.%s from %s to %s", TextFormatting.GRAY, n, Float.valueOf(b[n]), Float.valueOf(f))));
        ad.b[n] = f;
    ...
    public void b(ClientChatEvent clientChatEvent) {
        ...
        Minecraft.func_71410_x().field_71439_g.func_145747_a((ITextComponent)new TextComponentString(String.format("%sdev float N.%s is %s", TextFormatting.YELLOW, n, Float.valueOf(b[n]))));
        clientChatEvent.setCanceled(true);
    }
    ...
    public void d(ClientChatEvent clientChatEvent) {
        ...
        if ("girls".equals(string)) {
            ...
            for (em object : stringArray) {
                System.out.printf("%s at %s %s %s\n", new Object[]{object, object.field_70165_t, object.field_70163_u, object.field_70161_v});
            }
        }
        if ("kobs".equals(string)) {
            stringArray = ax.a(entityPlayerSP.getPersistentID());
            int n = ax.h((UUID)stringArray);
            List<ff> list = ax.n((UUID)stringArray);
            for (ff ff2 : list) {
                String string2;
                ad ad2;
                try {
                    this.a(String.format("alive member %s at %s world.isremote? %s isdead %s girlID %s entityID %s", ff2.c(), ff2.func_180425_c(), ff2.field_70170_p.field_72995_K, ff2.field_70128_L, ff2.f(), ff2.func_145782_y()));
                    ad2 = this;
                    string2 = entityPlayerSP.field_70170_p.func_72872_a(ff.class, new AxisAlignedBB(ff2.func_180425_c())).isEmpty() ? "couldn't be located" : "appears to actually exist";
                }
                catch (NullPointerException nullPointerException) {
                    throw ad.a(nullPointerException);
                }
        ...
        if (string.startsWith("setcumtime ")) {
            ...
            v.a(entityPlayerSP.getPersistentID(), l);
