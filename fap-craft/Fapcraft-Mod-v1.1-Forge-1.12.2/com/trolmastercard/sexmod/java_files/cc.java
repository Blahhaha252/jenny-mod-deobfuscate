...
implements IAnimatable {
    ...
    public void a(PlayerInteractEvent.EntityInteract entityInteract) {
        ...
        try {
            if (!((Object)((Object)r)).equals(itemStack.func_77973_b())) {
                return;
            }
        }
        catch (ConcurrentModificationException concurrentModificationException) {
    ...
    public void func_77663_a(ItemStack itemStack, World world, Entity entity, int n, boolean bl) {
        ...
        block10: {
            ...
            NBTTagCompound nBTTagCompound = entityPlayer.getEntityData();
            l3 = nBTTagCompound.func_74763_f(b);
            l2 = nBTTagCompound.func_74763_f(m);
            l = System.currentTimeMillis();
            try {
                try {
                    this.b(entityPlayer, nBTTagCompound, l, l3);
                    this.a(entityPlayer, nBTTagCompound, l, l2);
                    if (l2 == 0L || l <= l2 + 4000L) break block10;
                }
                catch (ConcurrentModificationException concurrentModificationException) {
                    throw cc.a(concurrentModificationException);
                }
        ...
        this.a(entityPlayer, l, l3);
        this.b(entityPlayer, l, l2);
    }
    ...
    void b(EntityPlayer entityPlayer, long l, long l2) {
        ...
        try {
            em2 = em32;
            n = entityPlayer.func_184614_ca().func_77973_b().equals((Object)r) ? 1 : -1;
        }
        catch (ConcurrentModificationException concurrentModificationException) {
            throw cc.a(concurrentModificationException);
        }
        Vec3d vec3d2 = em2.func_178787_e(ck.a((float)n * 0.1f, (double)(-0.01f + entityPlayer.field_70125_A * 0.0015f), 0.0, entityPlayer.field_70761_aq));
        float f = (float)(l - l2 - 1000L) / 2000.0f;
        Vec3d vec3d3 = b6.a(vec3d, vec3d2, (double)f);
        ez.b = 0.2f;
    ...
    void a(EntityPlayer entityPlayer, long l, long l2) {
        ...
        Vec3d vec3d3 = vec3d.func_178787_e(ck.a((float)n * 0.1f, (double)(-0.01f + entityPlayer.field_70125_A * 0.0015f), 0.0, entityPlayer.field_70761_aq));
        ...
        block19: {
            ...
            block21: {
                block20: {
                    ...
                    boolean bl = nBTTagCompound.func_74767_n(n);
                    try {
                        try {
                            if (bl) break block19;
                            l4 = l5;
    ...
    public void registerControllers(AnimationData animationData) {
        this.a = new AnimationController((IAnimatable)this, "controller", 0.0f, this::a);
