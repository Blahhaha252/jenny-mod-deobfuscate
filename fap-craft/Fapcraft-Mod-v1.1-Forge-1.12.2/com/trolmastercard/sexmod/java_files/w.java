...
public class w {
    ...
    public void a(@Nonnull a a2) {
        ...
        block6: {
            ...
            entityPlayer2 = world.func_152378_a(a2.d);
            entityPlayer = world.func_152378_a(a2.c);
            try {
                try {
        ...
        try {
            ...
            string = a2.b ? entityPlayer.func_70005_c_() : entityPlayer2.func_70005_c_();
        }
        catch (RuntimeException runtimeException) {
            throw w.a(runtimeException);
        }
        textComponentString2(stringBuilder.append(string).append(" ").append(TextFormatting.DARK_PURPLE).append(I18n.func_135052_a((String)"genderswap.sexpromt.playerxaskedfory", (Object[])new Object[0])).append(" ").append(TextFormatting.LIGHT_PURPLE).append(I18n.func_135052_a((String)a2.a, (Object[])new Object[0])).toString());
    ...
    public static class a {
        ...
        public a(String string, UUID uUID, UUID uUID2, boolean bl) {
            this.a = string;
            this.c = uUID;
            this.d = uUID2;
            this.e = 1200.0f;
