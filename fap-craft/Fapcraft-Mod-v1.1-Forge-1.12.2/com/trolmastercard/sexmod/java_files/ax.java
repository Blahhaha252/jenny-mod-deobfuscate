...
public class ax {
    ...
    public static void c(UUID uUID, ff ff2) {
        ...
        try {
            ...
            if (!ff2.aA) {
                ff2.func_184212_Q().func_187227_b(ff.N, (Object)a2.h.toString());
            }
        }
        catch (RuntimeException runtimeException) {
            throw ax.a(runtimeException);
    ...
    public static void a(UUID uUID, ff ff2) {
        ...
        block17: {
            ...
            try {
                a2.b(ff2);
                a2.b(ff2.f());
                if (a2.g == null || a2.g.func_145782_y() != ff2.func_145782_y()) break block17;
            }
            catch (RuntimeException runtimeException) {
                throw ax.a(runtimeException);
            }
    ...
    public static boolean e(UUID uUID, ff ff2) {
        ...
        try {
            bl = a2.g.func_145782_y() == ff2.func_145782_y();
        }
        catch (RuntimeException runtimeException) {
            throw ax.a(runtimeException);
        }
