...
lbl109:
    ...
    protected f.a a() {
        ...
        block62: {
                ...
                block61: {
                    ...
                    if (this.f != f.a.FOLLOW) {
                        ...
                        list.sort((entityMob, entityMob2) -> {
                            int n;
                            double d = entityMob.func_70032_d((Entity)this.q);
                            double d2 = entityMob2.func_70032_d((Entity)this.q);
                            try {
                                if (d == d2) {
                                    return 0;
                                }
                    ...
                    float f2 = this.q.func_70032_d((Entity)this.a);
                    try {
                        bl2 = f2 > 5.0f;
                    }
                    catch (RuntimeException runtimeException) {
                    ...
                    try {
                        try {
                            if (bl || this.f != f.a.FOLLOW) break block60;
                        }
                        catch (RuntimeException runtimeException) {
                            throw com.trolmastercard.sexmod.g.a(runtimeException);
                        }
            ...
            try {
                try {
                    if (!bl || this.f != f.a.ATTACK) break block62;
                }
                catch (RuntimeException runtimeException) {
                    throw com.trolmastercard.sexmod.g.a(runtimeException);
                }
