...
extends Gui {
    ...
    public void a(RenderGameOverlayEvent renderGameOverlayEvent) {
        ...
        float f2 = l < u + 500L ? (float)(l - u) / 500.0f : (l < g + 500L ? 1.0f + (float)(g - l) / 500.0f : 1.0f);
        f2 = be.b(f2, 0.0f, 1.0f);
        ...
        this.a(p, n3 + hf.w.c / 2 + 1, n2 - 70 + 3);
        float f3 = (float)b6.b(Math.min(1.0f, (float)(l - s) / 150.0f));
        try {
            f = f3 == 1.0f ? be.b(1.0f - (float)(l - hf.f) / 500.0f, 0.0f, 1.0f) : 0.0f;
        }
        catch (RuntimeException runtimeException) {
            throw hf.a(runtimeException);
        }
        float f4 = f;
        this.a(1, -1.5f * (float)hf.w.c, f4, f3, n3, n2, f2);
        this.a(2, (float)(-hf.w.c) / 2.0f, f4, f3, n3, n2, f2);
        this.a(3, (float)hf.w.c / 2.0f, f4, f3, n3, n2, f2);
    }
