...
extends GuiScreen {
        ...
        block60: {
            ...
            block61: {
                ...
                block58: {
                    ...
                    block59: {
                        ...
                        block57: {
                            block56: {
                                    ...
                                    block54: {
                                        ...
                                        block53: {
                                            block52: {
                                                ...
                                                try {
                                                    try {
                                                        j3.a = f8 + (float)n7 * this.field_146297_k.func_193989_ak();
                                                        j j4 = this;
                                                        j j5 = j4;
                                                        f7 = j4.k;
                                        ...
                                        try {
                                            try {
                                                j5.k = f7 + (float)n6 * this.field_146297_k.func_193989_ak();
                                                j j6 = this;
                                                j j7 = j6;
                                                f6 = j6.n;
                                ...
                                try {
                                    try {
                                        j7.n = f6 + (float)n5 * this.field_146297_k.func_193989_ak();
                                        j j8 = this;
                                        j j9 = j8;
                                        f4 = j8.i;
                        ...
                        try {
                            j9.i = f4 + (float)n4 * this.field_146297_k.func_193989_ak();
                            ...
                            this.func_175174_a(-62.0f + f2 - this.k * 15.0f, -62.0f + f2 - this.k * 15.0f, 0, 0, 64, 64);
                            this.c(f2);
                            if (d) {
                                this.func_175174_a(-62.0f + f2 - this.k * 15.0f, -62.0f + f2 - this.k * 15.0f, 128, 64, 64, 64);
                            }
                        }
                        catch (NullPointerException nullPointerException) {
                            throw com.trolmastercard.sexmod.j.a(nullPointerException);
                        ...
                        try {
                            ...
                            this.func_175174_a(-2.0f - f2 + this.n * 15.0f, -2.0f - f2 + this.n * 15.0f, 0, 0, 64, 64);
                            this.a(f2);
                            if (fa.b()) {
                                this.func_175174_a(-2.0f - f2 + this.n * 15.0f, -2.0f - f2 + this.n * 15.0f, 128, 64, 64, 64);
                            }
                        }
                        catch (NullPointerException nullPointerException) {
                            throw com.trolmastercard.sexmod.j.a(nullPointerException);
                        ...
                        boolean bl4 = block instanceof BlockChest;
                        bl3 = block instanceof BlockBed;
                        try {
                            try {
                                try {
                                    if (!bl4 && !bl3) break block58;
                                }
                                catch (NullPointerException nullPointerException) {
                                    throw com.trolmastercard.sexmod.j.a(nullPointerException);
                                }
                                ...
                                this.func_175174_a(-62.0f + f2 - this.a * 15.0f, -2.0f - f2 + this.a * 15.0f, 0, 0, 64, 64);
                    ...
                    try {
                        if (gm.a(this.c)) {
                            this.func_175174_a(-62.0f + f2 - this.a * 15.0f, -2.0f - f2 + this.a * 15.0f, 128, 64, 64, 64);
                        }
                    }
                    catch (NullPointerException nullPointerException) {
                        throw com.trolmastercard.sexmod.j.a(nullPointerException);
                ...
                try {
                    try {
                        ...
                        this.func_175174_a(-2.0f - f2 + this.i * 15.0f, -62.0f + f2 - this.i * 15.0f, 0, 0, 64, 64);
            ...
            try {
                if (gm.a(this.c)) {
                    this.func_175174_a(-2.0f - f2 + this.i * 15.0f, -62.0f + f2 - this.i * 15.0f, 128, 64, 64, 64);
                }
            }
            catch (NullPointerException nullPointerException) {
                throw com.trolmastercard.sexmod.j.a(nullPointerException);
    ...
    void a(float f) {
        this.func_175174_a(-2.0f - f + this.n * 15.0f, -2.0f - f + this.n * 15.0f, 192, 64, 64, 64);
    }

    void c(float f) {
        this.func_175174_a(-62.0f + f - this.k * 15.0f, -62.0f + f - this.k * 15.0f, 64, 64, 64, 64);
    }

    void e(float f) {
        this.func_175174_a(-2.0f - f + this.i * 15.0f, -62.0f + f - this.i * 15.0f, 64, 0, 64, 64);
    }

    void b(float f) {
        this.func_175174_a(-2.0f - f + this.i * 15.0f, -62.0f + f - this.i * 15.0f, 128, 0, 64, 64);
    }

    void f(float f) {
        this.func_175174_a(-62.0f + f - this.a * 15.0f, -2.0f - f + this.a * 15.0f, 0, 64, 64, 64);
    }

    void d(float f) {
        this.func_175174_a(-62.0f + f - this.a * 15.0f, -2.0f - f + this.a * 15.0f, 192, 0, 64, 64);
    }
