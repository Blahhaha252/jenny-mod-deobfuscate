...
extends GeoEntityRenderer<cy> {
    ...
    void a(br.b b2, cy cy2, float f) {
        Vec3d vec3d;
        block6: {
            try {
                try {
                    if (b2 != null && b2.i() != c8.DEFAULT) break block6;
                }
                catch (IllegalStateException illegalStateException) {
                    throw com.trolmastercard.sexmod.b.a(illegalStateException);
                }
        ...
        try {
            ...
            b b4 = this;
            vec3d = b2.i() == c8.SEXMOD ? cj.a(cy2, f) : null;
        }
        catch (IllegalStateException illegalStateException) {
            throw com.trolmastercard.sexmod.b.a(illegalStateException);
        }
        ...
        block4: {
            ...
            try {
                try {
                    ...
                    if (cy2.f && f == 2.876945f) break block4;
                }
                catch (IllegalStateException illegalStateException) {
                    throw com.trolmastercard.sexmod.b.a(illegalStateException);
                }
