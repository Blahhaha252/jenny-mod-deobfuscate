        ...
        block27: {
            block26: {
                block23: {
                    ...
                    int n4 = n3 * this.func_70681_au().nextInt(10);
                    try {
                    ...
                    int n5 = n2 * this.func_70681_au().nextInt(10);
                    try {
                        n = this.field_70170_p.field_73011_w.func_186058_p() == DimensionType.NETHER ? (int)Math.ceil(this.field_70163_u) : cj.a(this.field_70170_p, this.func_180425_c().func_177958_n() + n4, this.func_180425_c().func_177952_p() + n5);
                    }
                    catch (RuntimeException runtimeException) {
                        throw al.a(runtimeException);
                    }
                    int n6 = n;
                    this.f = new BlockPos(this.func_180425_c().func_177958_n() + n4, n6, this.func_180425_c().func_177952_p() + n5);
                    this.d = 0;
                }
                try {
