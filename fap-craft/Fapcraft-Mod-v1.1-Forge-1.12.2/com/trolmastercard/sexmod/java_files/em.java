...
implements IAnimatable {
    ...
    public void a(a a2) {
        this.m.func_187227_b(a, (Object)a2.toString());
    }
    ...
    public void b(float f) {
        this.m.func_187227_b(w, (Object)Float.valueOf(f));
    }
    ...
    public void a(boolean bl) {
        ...
        this.m.func_187227_b(G, (Object)bl);
    }
    ...
    protected static void a(EntityPlayer entityPlayer, em em2, String[] stringArray, ItemStack[] itemStackArray, boolean bl) {
        Minecraft.func_71410_x().func_147108_a((GuiScreen)new m(em2, entityPlayer, stringArray, itemStackArray, bl));
    }

    @SideOnly(value=Side.CLIENT)
    protected static void a(EntityPlayer entityPlayer, em em2, String[] stringArray, boolean bl) {
        Minecraft.func_71410_x().func_147108_a((GuiScreen)new m(em2, entityPlayer, stringArray, null, bl));
    }
    ...
    public boolean J() {
        boolean bl;
        try {
            bl = !((String)this.m.func_187225_a(v)).equals("");
        }
        catch (ConcurrentModificationException concurrentModificationException) {
            throw em.c(concurrentModificationException);
        }
        ...
        try {
            for (em em2 : em.ad()) {
                ...
                block14: {
                    ...
                    bl2 = em2.field_70170_p.field_72995_K;
                    try {
    ...
    public static em c(@Nonnull UUID uUID) {
        ...
        try {
            for (em em2 : em.ad()) {
                ...
                boolean bl3 = em2.field_70170_p.field_72995_K;
                try {
                    if (bl3 != bl2) {
                        continue;
                    }
    ...
    protected void a(double d, double d2, double d4, float f, float f2) {
        ...
        Vec3d vec3d = this.B;
        vec3d = vec3d.func_72441_c(-Math.sin((double)(this.r + 90.0f) * (Math.PI / 180)) * d, 0.0, Math.cos((double)(this.r + 90.0f) * (Math.PI / 180)) * d);
        vec3d = vec3d.func_72441_c(0.0, d2, 0.0);
        vec3d = vec3d.func_72441_c(-Math.sin((double)this.r * (Math.PI / 180)) * d4, 0.0, Math.cos((double)this.r * (Math.PI / 180)) * d4);
        try {
            if (this.field_70170_p.field_72995_K) {
        ...
        entityPlayer.func_70080_a(vec3d.field_72450_a, vec3d.field_72448_b, vec3d.field_72449_c, this.r + f, f2);
        entityPlayer.func_70634_a(vec3d.field_72450_a, vec3d.field_72448_b, vec3d.field_72449_c);
    ...
    public void a(SoundEvent soundEvent, float f, float f2) {
        this.field_70170_p.func_184134_a((double)this.func_180425_c().func_177958_n(), (double)this.func_180425_c().func_177956_o(), (double)this.func_180425_c().func_177952_p(), soundEvent, SoundCategory.NEUTRAL, f, f2, false);
    }
    ...
    public void a(SoundEvent[] soundEventArray, float f) {
        this.a(soundEventArray[this.func_70681_au().nextInt(soundEventArray.length)], f, 1.0f);
    }
    ...
    public Vec3d a(double d) {
        ...
        return entityPlayer.func_174791_d().func_72441_c(-Math.sin((double)f * (Math.PI / 180)) * d, 0.0, Math.cos((double)f * (Math.PI / 180)) * d);
    }
    ...
    public MatrixStack a(String string, boolean bl) {
        ...
        block17: {
            ...
            try {
                if (bl) {
                    geoBone.rotateY((float)(-Math.toRadians(b6.a(this.field_70760_ar, this.field_70761_aq, Minecraft.func_71410_x().func_184121_ak()))));
                }
            }
            catch (ConcurrentModificationException concurrentModificationException) {
                throw em.c(concurrentModificationException);
