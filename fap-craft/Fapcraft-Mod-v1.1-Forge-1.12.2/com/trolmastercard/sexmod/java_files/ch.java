...
extends GuiScreen {
    ...
    public void func_73863_a(int n, int n2, float f) {
        ...
        int n8 = scaledResolution.func_78326_a();
        try {
            ...
            guiButton = guiButton3;
            n7 = 0;
            n6 = n8 / 2 - 119 + (int)(100.0 - 100.0 * this.d);
            n5 = 30;
            n4 = (int)(this.d * 100.0);
            n3 = 20;
        ...
        guiButton2(n7, n6, n5, n4, n3, string);
        list.add(guiButton);
        this.field_146292_n.add(new GuiButton(1, n8 / 2 + 19, 30, (int)(this.d * 100.0), 20, I18n.func_135052_a((String)"action.names.gohome", (Object[])new Object[0])));
        this.field_146297_k.field_71446_o.func_110577_a(b);
        this.func_73729_b(n8 / 2 - 7, 61 - (int)(15.0 - this.d * 15.0), 32, 0, 15, 15);
        this.field_146292_n.add(new GuiButton(2, n8 / 2 - 10, 59 - (int)(15.0 - this.d * 15.0), 20, 20, ""));
        this.func_73729_b(n8 / 2 - 20, 20, (Boolean)this.c.func_184212_Q().func_187225_a(fo.K) != false ? 0 : 40, 130, 40, 40);
    }
