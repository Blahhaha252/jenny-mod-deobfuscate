...
extends EntityAIBase {
    ...
    public void func_75246_d() {
        block4: {
            float f = (float)((double)((float)this.b.func_177958_n() + 0.5f) - this.c.field_70165_t);
            float f2 = (float)((double)((float)this.b.func_177952_p() + 0.5f) - this.c.field_70161_v);
            float f3 = this.f * f + this.a * f2;
            try {
                try {
                    if (!(f3 < 0.0f) || --this.g > 0) break block4;
                }
                catch (IllegalArgumentException illegalArgumentException) {
                    throw hz.a(illegalArgumentException);
                }
