...
implements bh {
    ...
    boolean i() {
        ...
        try {
            bl = this.field_70170_p.func_180495_p(this.func_180425_c().func_177982_a(0, 2, 0)).func_177230_c() != Blocks.field_150350_a;
        }
        catch (RuntimeException runtimeException) {
            throw el.a(runtimeException);
        }
    ...
    void e() {
        ...
        Vec3d vec3d = this.o().func_178787_e(ck.a(new Vec3d(0.0, (double)(2.5625f - entityPlayer.func_70047_e()), -0.3125), 180.0f + f));
        ...
        do {
            ...
            for (int i = 0; i < vec3dArrayArray.length; ++i) {
                block7: {
                    ...
                    Vec3d vec3d3 = vec3d.func_178787_e(vec3dArrayArray[i][2]);
    ...
    void d() {
        ...
        this.e(entityPlayer.getPersistentID());
        float f = (float)(Math.atan2(this.field_70161_v - entityPlayer.field_70161_v, this.field_70165_t - entityPlayer.field_70165_t) * 57.29577951308232);
        this.b(f);
