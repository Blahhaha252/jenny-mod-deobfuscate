...
b7 {
    ...
    void af() {
        ...
        block22: for (float f4 = 0.0f; f4 < 1.0f; f4 += f) {
            ...
            while (true) {
                    ...
                    block27: {
                        try {
                            try {
                                ...
                                d9 = vec3d4.field_72450_a;
                                d8 = random.nextDouble() * 0.25;
                ...
                try {
                    d7 = d9 + d8 * (double)n5;
                    d6 = vec3d4.field_72448_b;
                    d5 = random.nextDouble() * 0.25;
                ...
                world.func_175688_a(enumParticleTypes, d7, d4, d2 + d * (double)n3, 0.0, 0.0, 0.0, new int[0]);
                ++n2;
            }
        }
        int n6 = 0;
        while (true) {
            ...
            try {
                d14 = d17 + d15 * (double)n9;
                d13 = vec3d3.field_72448_b;
                d12 = random.nextDouble() * 0.25;
            ...
            try {
                d11 = d13 + d12 * (double)n8;
                d10 = vec3d3.field_72449_c;
                d = random.nextDouble() * 0.25;
            ...
            world.func_175688_a(enumParticleTypes, d14, d11, d10 + d * (double)n7, 0.0, 0.0, 0.0, new int[0]);
            ++n6;
        }
    }
    ...
    void d(EntityPlayer entityPlayer) {
        ...
        try {
            ...
            vec3d2 = vec3d3;
            vec3d = vec3d3;
            d2 = entityPlayer.field_70165_t;
            d = entityPlayer.field_70163_u;
            f = ei2 == null ? entityPlayer.eyeHeight : ei2.func_70047_e();
        }
        catch (ConcurrentModificationException concurrentModificationException) {
            throw f_.a(concurrentModificationException);
        }
        vec3d2(d2, d + (double)f, entityPlayer.field_70161_v);
        Vec3d vec3d4 = vec3d;
        Vec3d vec3d5 = new Vec3d(this.field_70165_t, this.field_70163_u + (double)this.func_70047_e(), this.field_70161_v);
        double d4 = vec3d5.func_72438_d(vec3d4);
        double d5 = vec3d4.field_72448_b - vec3d5.field_72448_b;
        this.field_70125_A = (float)(-(Math.sin(d5 / d4) * 57.29577951308232));
    }
    ...
    boolean ai() {
                    ...
                    block35: {
                        block37: {
                            ...
                            block36: {
                                ...
                                f = this.func_70032_d((Entity)entityPlayer);
        ...
        boolean bl3 = bl2;
        try {
            d = bl3 ? (double)0.55f : 0.5;
        }
        catch (ConcurrentModificationException concurrentModificationException) {
            throw f_.a(concurrentModificationException);
        }
        double d2 = d;
        double d4 = Math.floor(f / 5.0f) * 0.2;
        d2 += d4;
        if (this.func_70090_H()) {
            d2 *= 60.0;
        }
        pathNavigate.func_75489_a(d2);
    ...
    void H() {
        ...
        try {
            f4 = this.k() ? 0.0f : this.I().floatValue() + 180.0f;
        }
        catch (ConcurrentModificationException concurrentModificationException) {
            throw f_.a(concurrentModificationException);
        }
        entityPlayerSP.field_70177_z = f = f4;
    ...
    void T() {
        ...
        if (this.field_70170_p.func_180495_p(blockPos).func_177230_c() instanceof BlockLiquid) {
            ...
            for (int i = -1; i < 2; ++i) {
                try {
                    for (int j = -1; j < 2; ++j) {
                        this.field_70170_p.func_175656_a(blockPos2.func_177982_a(i, 0, j), Blocks.field_150343_Z.func_176223_P());
                    }
                    continue;
                }
                catch (ConcurrentModificationException concurrentModificationException) {
    ...
    void I() {
        ...
        float f4 = f;
        Vec3d vec3d = new Vec3d((double)f4, (double)f4, (double)f4);
    ...
    boolean f() {
        ...
        float f4 = this.func_70032_d((Entity)entityLivingBase);
        try {
    ...
    boolean a(EntityPlayer entityPlayer, EnumHand enumHand) {
        block13: {
            ...
            try {
                try {
                    if (!((Object)((Object)cc.r)).equals(entityPlayer.func_184586_b(EnumHand.OFF_HAND).func_77973_b()) && !((Object)((Object)cc.r)).equals(entityPlayer.func_184586_b(EnumHand.MAIN_HAND).func_77973_b())) break block13;
                }
                catch (ConcurrentModificationException concurrentModificationException) {
                    throw f_.a(concurrentModificationException);
                }
    ...
    public static Float a(f_ f_2, float f) {
        ...
        Vec3d vec3d = com.trolmastercard.sexmod.b6.a(new Vec3d(entityLivingBase.field_70142_S, entityLivingBase.field_70137_T, entityLivingBase.field_70136_U), entityLivingBase.func_174791_d(), (double)f);
        Vec3d vec3d2 = com.trolmastercard.sexmod.b6.a(new Vec3d(f_2.field_70142_S, f_2.field_70137_T, f_2.field_70136_U), f_2.func_174791_d(), (double)f);
        Vec3d vec3d3 = vec3d.func_178788_d(vec3d2);
        f_2.field_70761_aq = f4 = (float)gc.b(Math.atan2(vec3d3.field_72449_c, vec3d3.field_72450_a)) - 90.0f;
        f_2.field_70760_ar = f4;
    ...
    public void func_180430_e(float f, float f4) {
    }
        ...
        public void a(RenderWorldLastEvent renderWorldLastEvent) {
            ...
            try {
                for (em em2 : em.ad()) {
                    ...
                    Vec3d vec3d3 = com.trolmastercard.sexmod.b6.a(new Vec3d(em2.field_70142_S, em2.field_70137_T, em2.field_70136_U), em2.func_174791_d(), (double)f);
