...
extends em {
    ...
    void u() {
        ...
        boolean bl2 = bl;
        this.func_189654_d(bl2);
        this.field_70145_X = bl2;
    }
    ...
    void a(int n) {
        ...
        try {
            ...
            f82 = this;
            l = n == -1 ? -1L : this.field_70170_p.func_82737_E();
        }
        catch (RuntimeException runtimeException) {
            throw f8.a(runtimeException);
        }
    ...
    public static boolean a(Entity entity, f_ f_2) {
        ...
        try {
            f = f3 == null ? f_2.field_70759_as : f3.floatValue();
        }
        catch (RuntimeException runtimeException) {
            throw f8.a(runtimeException);
        }
        float f4 = f;
        Vec3d vec3d2 = ck.a(vec3d, f4);
        try {
    ...
    void m() {
        ...
        float f4 = (float)(gc.b(Math.atan2(vec3d3.field_72449_c, vec3d3.field_72450_a)) + 90.0);
        Float f5 = f_.a(f_2, 0.0f);
        f4 -= f_2.field_70759_as;
        if (f5 != null) {
            f4 -= f5.floatValue();
        }
        try {
            f8 f82 = this;
            f3 = Math.abs(cj.a(0.0f, f4)) < 80.0f ? -gc.c(f4) : 0.0f;
        }
        catch (RuntimeException runtimeException) {
            throw f8.a(runtimeException);
        }
        try {
            f82.af = f3;
            f8 f83 = this;
            f = this.af == 0.0f ? 0.0f : (float)be.b(-vec3d3.field_72448_b / 2.0, -0.75, 0.75);
        }
        catch (RuntimeException runtimeException) {
            throw f8.a(runtimeException);
        }
    ...
    Entity o() {
        ...
        for (EntityPlayer entityPlayer : this.field_70170_p.field_73010_i) {
            ...
            try {
                if (entity != null && !(entity.func_70032_d((Entity)this) > f)) continue;
            }
            catch (RuntimeException runtimeException) {
                throw f8.a(runtimeException);
            }
    ...
    protected boolean a(fp fp2, String string, boolean bl, AnimationEvent animationEvent) {
        block38: {
            block37: {
                ...
                try {
                    if (bl || fp2 != fp.THREESOME_FAST) break block37;
                }
                catch (RuntimeException runtimeException) {
                    throw f8.a(runtimeException);
                }
