...
extends EntityLiving {
     ...
     */
    private static ArrayList<ay> a(Vec3d vec3d, double d2) {
        ...
        try {
            for (ay ay2 : g) {
                ...
                double d3 = Math.abs(ay2.field_70169_q - vec3d.field_72450_a) + Math.abs(ay2.field_70167_r - vec3d.field_72448_b) + Math.abs(ay2.field_70166_s - vec3d.field_72449_c);
            ...
            System.out.println("couldnt find slimes at distance " + d2);
        }
        return arrayList;
    }
    ...
    public void func_70106_y() {
        block11: {
            ...
            try {
                try {
                    if (this.field_70170_p.field_72995_K || n <= 1) break block11;
                }
                catch (RuntimeException runtimeException) {
                    throw ay.a(runtimeException);
                }
