...
public class ef {
    public static void a(BufferBuilder bufferBuilder, Tessellator tessellator, Minecraft minecraft, b b2) {
        Vec3d[] vec3dArray;
        int n;
    ...
    public static class b {
        ...
        public b(gv gv2, float f, int n, float f2, a a2, a a3, a a4, float f3, float f4) {
            this.h = gv2;
            this.e = f;
            this.c = n;
            this.g = f2;
