                    ...
                    for (em em2 : em.ad()) {
                        block22: {
                            block25: {
                                block24: {
                                    if (em2.field_70170_p.field_72995_K) continue;
                                    if (em2.func_180425_c().func_177958_n() != n2) continue;
                                    break block24;
                                    catch (ConcurrentModificationException concurrentModificationException) {
                                        throw et.a(concurrentModificationException);
                                    }
                                }
                                if (em2.func_180425_c().func_177956_o() != n3) continue;
                                break block25;
                                catch (ConcurrentModificationException concurrentModificationException) {
                                    throw et.a(concurrentModificationException);
                                }
                            ...
                            try {
                                block26: {
                                    if (em2.func_180425_c().func_177952_p() != n4) continue;
                                    break block26;
                                    catch (ConcurrentModificationException concurrentModificationException) {
                                        throw et.a(concurrentModificationException);
                                    }
