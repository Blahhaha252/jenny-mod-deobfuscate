            ...
            block34: {
                ...
                block33: {
                    ...
                    block29: {
                        ...
                        file.mkdirs();
                        File file2 = new File(string2 + "/" + string + b2.ending);
                        try {
                            Throwable throwable;
                    ...
                    n3 = 0;
                    n2 = cu.b.values().length;
                    for (cu.b b4 : cu.b.values()) {
                        try {
                            if (!new File(string2 + "/" + string + b4.ending).exists()) continue;
                            ++n3;
                        }
                        catch (Throwable throwable) {
                            throw cu.a.a(throwable);
        ...
        minecraftServer.func_152344_a(() -> {
            ...
            for (String object : list) {
                ...
                for (cu.b b2 : cu.b.values()) {
                    File file = new File(string + "/" + object + b2.ending);
                    try {
                        if (!file.exists()) {
                    ...
                    arrayList.add(new cu(byArray, b2, object));
                }
            }
