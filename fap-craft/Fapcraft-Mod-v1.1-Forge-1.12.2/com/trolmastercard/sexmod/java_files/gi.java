...
extends Entity {
    ...
    public void func_184206_a(DataParameter<?> dataParameter) {
        if (g.equals(dataParameter)) {
            ...
            try {
                gi gi2 = this;
                entity = n > 0 ? this.field_70170_p.func_73045_a(n - 1) : null;
            }
            catch (RuntimeException runtimeException) {
                throw gi.a(runtimeException);
            }
                ...
                if (this.n == com.trolmastercard.sexmod.gi$a.BOBBING) {
                    ...
                    try {
                        try {
                            ...
                            if (this.field_70170_p.field_72995_K || !(f > 0.0f)) break block48;
                        }
                        catch (RuntimeException runtimeException) {
                            throw gi.a(runtimeException);
                        }
    ...
    private void a(BlockPos blockPos) {
        ...
        block34: {
            block35: {
                ...
                block36: {
                    ...
                    float f3 = this.e * ((float)Math.PI / 180);
                    f2 = MathHelper.func_76126_a((float)f3);
                    f = MathHelper.func_76134_b((float)f3);
                    d3 = this.field_70165_t + (double)(f2 * (float)this.j * 0.1f);
                    d2 = (float)MathHelper.func_76128_c((double)this.func_174813_aQ().field_72338_b) + 1.0f;
                    d = this.field_70161_v + (double)(f * (float)this.j * 0.1f);
                    IBlockState iBlockState = worldServer.func_180495_p(new BlockPos(d3, d2 - 1.0, d));
                    try {
                        try {
                        ...
                        worldServer.func_175739_a(EnumParticleTypes.WATER_BUBBLE, d3, d2 - (double)0.1f, d, 1, (double)f2, 0.1, (double)f, 0.0, new int[0]);
                    }
                    catch (RuntimeException runtimeException) {
                        throw gi.a(runtimeException);
                    }
                ...
                float f4 = f2 * 0.04f;
                float f5 = f * 0.04f;
                worldServer.func_175739_a(EnumParticleTypes.WATER_WAKE, d3, d2, d, 0, (double)f5, 0.01, (double)(-f4), 1.0, new int[0]);
                worldServer.func_175739_a(EnumParticleTypes.WATER_WAKE, d3, d2, d, 0, (double)(-f5), 0.01, (double)f4, 1.0, new int[0]);
                return;
            }
        ...
        if (this.c > 0) {
            ...
            if (this.field_70146_Z.nextFloat() < f) {
                ...
                double d = this.field_70165_t + (double)(MathHelper.func_76126_a((float)f6) * f7 * 0.1f);
                double d4 = (float)MathHelper.func_76128_c((double)this.func_174813_aQ().field_72338_b) + 1.0f;
                double d5 = this.field_70161_v + (double)(MathHelper.func_76134_b((float)f6) * f7 * 0.1f);
                IBlockState iBlockState = worldServer.func_180495_p(new BlockPos((int)d, (int)d4 - 1, (int)d5));
                try {
                    if (iBlockState.func_185904_a() == Material.field_151586_h) {
                        worldServer.func_175739_a(EnumParticleTypes.WATER_SPLASH, d, d4, d5, 2 + this.field_70146_Z.nextInt(2), (double)0.1f, 0.0, (double)0.1f, 0.0, new int[0]);
                    }
                }
                catch (RuntimeException runtimeException) {
                    throw gi.a(runtimeException);
    ...
    public int c() {
        block11: {
            ...
            try {
                n = var2_2 == null ? n2 : var2_2.getRodDamage();
            }
            catch (RuntimeException runtimeException) {
                throw gi.a(runtimeException);
            }
