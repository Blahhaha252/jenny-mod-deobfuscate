...
implements IWorldGenerator {
    ...
    public NBTTagCompound func_189551_b(NBTTagCompound nBTTagCompound) {
        ...
        int n = 0;
        for (a a2 : this.d) {
            nBTTagCompound2.func_74778_a("sexmod:name" + n, a2.a);
            nBTTagCompound2.func_74778_a("sexmod:pos" + n++, g3.a(a2.b));
        }
    ...
    void a(b b2, Random random, int n, int n2, World world) {
        int n3;
        int n4;
        int n5;
        int n6;
        for (a a2 : this.d) {
            ...
            n6 = n7;
            try {
                if (!(a2.b.a(n, n2) < (float)n6)) continue;
                return;
            }
            catch (RuntimeException runtimeException) {
                throw g3.a(runtimeException);
        ...
        int n8 = b2.c.func_177958_n();
        int n9 = b2.c.func_177952_p();
        n6 = n * 16 + (16 - n8) / 2;
        int n10 = n2 * 16 + (16 - n9) / 2;
        Biome biome = world.field_73011_w.getBiomeForCoords(new BlockPos(n6, 80, n10));
        try {
        ...
        for (n5 = n6; n5 < n6 + n8; ++n5) {
            for (n4 = n10; n4 < n10 + n9; ++n4) {
                block29: {
                    n3 = cj.a(world, n5, n4);
                    try {
                        try {
                            if (!b2.d || world.func_180495_p(new BlockPos(n5, n3, n4)).func_177230_c() != Blocks.field_150355_j) break block29;
                        }
                        catch (RuntimeException runtimeException) {
                            throw g3.a(runtimeException);
                        }
        ...
        n5 = n11;
        try {
            this.d.add(new a(new e1(n, n2), b2.f));
            b2.b.func_180709_b(world, random, new BlockPos(n6, n5, n10));
            if (!b2.d) {
                return;
            }
        }
        ...
        while (n4 != 0) {
            n4 = 0;
            Vec3i vec3i = new Vec3i(n8 + 2, 0, n9 + 2);
            --n10;
            for (int i = --n6; i < n6 + vec3i.func_177958_n(); ++i) {
                for (int j = n10; j < n10 + vec3i.func_177952_p(); ++j) {
    ...
    void a(World world, Random random, int n, int n2) {
        ...
        block49: {
            ...
            blockPos2 = new BlockPos(n3, n5, n4);
                            ...
                            try {
                                block47: {
                                    try {
                                        try {
                                            if (bl) break block46;
                                            if (j == -1) break block47;
                                        }
                                        catch (RuntimeException runtimeException) {
                                            throw g3.a(runtimeException);
                                        }
                                        if (j != e3.ah.func_177956_o()) break block46;
                                    }
                                    catch (RuntimeException runtimeException) {
                                        throw g3.a(runtimeException);
                                    }
                                    ...
                                    try {
                                        block48: {
                                            try {
                                                try {
                                                    try {
                                                        if (i == 0 || i == e3.ah.func_177958_n()) break block48;
                                                    }
                                                    catch (RuntimeException runtimeException) {
                                                        throw g3.a(runtimeException);
                                                    }
                                                    if (k == 0) break block48;
                                                }
                                                catch (RuntimeException runtimeException) {
                                                    throw g3.a(runtimeException);
                                                }
                                                if (k != e3.ah.func_177952_p()) continue;
                                            }
                                            catch (RuntimeException runtimeException) {
                                                throw g3.a(runtimeException);
                                            }
    ...
    static class b {
        ...
        public b(String string, HashSet<Biome> hashSet, Vec3i vec3i, int n, boolean bl) {
            this.f = string;
            this.e = hashSet;
            this.c = vec3i;
            this.d = bl;
