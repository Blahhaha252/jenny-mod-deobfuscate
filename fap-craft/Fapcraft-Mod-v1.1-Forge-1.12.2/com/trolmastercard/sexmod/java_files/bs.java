...
public class bs {
    ...
    public bs(BlockPos blockPos, a a2, HashSet<BlockPos> hashSet) {
        this.a = blockPos;
        this.c = a2;
        this.b = hashSet;
    }

    public bs(BlockPos blockPos, a a2, HashSet<BlockPos> hashSet, EnumFacing enumFacing) {
        this.a = blockPos;
        this.c = a2;
        this.b = hashSet;
        this.e = enumFacing;
