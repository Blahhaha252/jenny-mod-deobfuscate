...
public enum h8 {
    CHANGE_POSITION(f_2 -> {
        ...
        int n2 = 0;
        try {
            bl = !world.func_175623_d(blockPos.func_177977_b());
        }
                                                    ...
                                                    block54: {
                                                        block53: {
                                                            block52: {
                                                                ...
                                                                blockPos3 = blockPos2.func_177971_a((Vec3i)new BlockPos(i, j, n3));
                                                                try {
                                                                    try {
                                                                        if (!bl2 || blockPos.func_177956_o() < blockPos3.func_177956_o()) break block52;
                                                                        break block51;
                                                                    }
                                                                    catch (RuntimeException runtimeException) {
                                                                        throw h8.a(runtimeException);
                                        ...
                                        block61: {
                                            try {
                                                try {
                                                    ...
                                                    if (!world.func_175623_d(blockPos3.func_177982_a(k, n6, i2))) break block61;
                                                }
                                                catch (RuntimeException runtimeException) {
                                                    throw h8.a(runtimeException);
                                                }
                    ...
                    block11: {
                        ...
                        block13: {
                            block12: {
                                ...
                                bl = (Boolean)f_2.func_184212_Q().func_187225_a(f_.ay);
                                try {
                                    try {
    ...
    RAPE(f_2 -> {
        ...
        block29: {
            ...
            for (EntityPlayer entityPlayer2 : list) {
                ...
                d = Math.abs(vec3d7.field_72450_a);
                try {
                    if (d > (double)0.65f) {
                        continue;
                    }
            ...
            try {
                boolean bl2 = bl = vec3d3.func_72438_d(new Vec3d(vec3d.field_72450_a, vec3d3.field_72448_b, vec3d.field_72449_c)) > vec3d3.func_72438_d(new Vec3d(vec3d2.field_72450_a, vec3d3.field_72448_b, vec3d2.field_72449_c));
            }
            catch (RuntimeException runtimeException) {
                throw h8.a(runtimeException);
            }
            if (bl) {
                d = ck.a((Vec3d)entityPlayer2, vec3d2, vec3d3);
                d2 = entityPlayer2.func_72438_d(vec3d2);
            } else {
                d = ck.a(vec3d, (Vec3d)entityPlayer2, vec3d3);
                d2 = vec3d.func_72438_d((Vec3d)entityPlayer2);
            }
            double d3 = d2 / (double)0.05f;
            double d4 = 1.0 / d3 * 20.0;
            d += d4;
            try {
                try {
                    if (bl || !(d < (double)0.9f)) break block29;
                }
                catch (RuntimeException runtimeException) {
                    throw h8.a(runtimeException);
                }
        ...
        vec3d3 = bl ? new Vec3d(b6.b(entityPlayer2.field_72450_a, vec3d2.field_72450_a, Math.min(1.0, d)), b6.b(entityPlayer2.field_72448_b, vec3d2.field_72448_b, Math.min(1.0, b6.a(d))), b6.b(entityPlayer2.field_72449_c, vec3d2.field_72449_c, Math.min(1.0, d))) : new Vec3d(b6.b(vec3d.field_72450_a, entityPlayer2.field_72450_a, d), b6.b(vec3d.field_72448_b, entityPlayer2.field_72448_b, b6.g(d)), b6.b(vec3d.field_72449_c, entityPlayer2.field_72449_c, d));
        try {
            f_2.func_70107_b(vec3d3.field_72450_a, vec3d3.field_72448_b, vec3d3.field_72449_c);
            if (bl) {
                f_2.func_184212_Q().func_187227_b(f_.bO, (Object)Float.valueOf((float)d));
            }
        }
        catch (RuntimeException runtimeException) {
            throw h8.a(runtimeException);
        ...
        try {
            bl = f_2.func_70011_f(vec3d4.field_72450_a, vec3d4.field_72448_b, vec3d4.field_72449_c) < (double)0.1f;
        }
        catch (RuntimeException runtimeException) {
            throw h8.a(runtimeException);
        }
