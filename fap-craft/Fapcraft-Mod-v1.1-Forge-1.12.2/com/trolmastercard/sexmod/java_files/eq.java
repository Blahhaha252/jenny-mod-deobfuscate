...
implements ai {
    ...
    public boolean a(fp fp2, EntityPlayer entityPlayer) {
        ...
        try {
            f2 = fp2 == fp.PICK_UP ? 180.0f : 0.0f;
        }
        catch (RuntimeException runtimeException) {
            throw eq.a(runtimeException);
        }
        float f5 = f2;
        float f6 = entityPlayer2.field_70177_z - 90.0f + f5;
        float f8 = entityPlayer2.field_70177_z + 90.0f + f5;
        try {
            if (f4 < f6) {
        ...
        try {
            if (f4 > f8) {
                entityPlayer.field_70177_z = f8;
            }
        }
        catch (RuntimeException runtimeException) {
            throw eq.a(runtimeException);
        }
        float f9 = entityPlayer.field_70125_A;
        try {
            f = fp2 == fp.PICK_UP ? 0.0f : 37.5f;
        }
        catch (RuntimeException runtimeException) {
            throw eq.a(runtimeException);
        }
    ...
    void d() {
        ...
        if (n2 == 15) {
            ...
            Vec3d vec3d = e3.a(new Vec3d(0.0, 0.0, 1.5), f2, f);
            try {
