        ...
        block22: {
            ...
            if (!damageSource2.func_76363_c()) {
                for (ItemArmor itemArmor : arrayList) {
                    n += a.a(itemArmor.field_77881_a, itemArmor.func_82812_d());
                    n2 += a.b(itemArmor.field_77881_a, itemArmor.func_82812_d());
                }
            }
            f = livingDamageEvent.getAmount();
            ...
            for (ItemStack itemStack : arrayList2) {
                ...
                try {
                    f5 = f2;
                    f4 = r.f.nextFloat() < 0.15f * (float)n5 ? r.f.nextFloat() * 4.0f + 1.0f : 0.0f;
                }
                catch (RuntimeException runtimeException) {
                    throw gu.a(runtimeException);
                }
            ...
            try {
                if (!(f2 > 0.0f) || !(damageSource2 instanceof EntityDamageSource)) break block22;
            }
            catch (RuntimeException runtimeException) {
                throw gu.a(runtimeException);
            }
