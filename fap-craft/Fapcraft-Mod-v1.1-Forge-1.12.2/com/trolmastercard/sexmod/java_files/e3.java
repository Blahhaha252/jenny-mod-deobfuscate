...
implements ai {
        ...
        block31: {
            block30: {
                block27: {
                    ...
                    int n3 = n2 * this.func_70681_au().nextInt(5);
                    try {
                        n = this.func_70681_au().nextBoolean() ? 1 : -1;
                    }
                    catch (ConcurrentModificationException concurrentModificationException) {
                        throw e3.a(concurrentModificationException);
                    }
                    int n4 = n * this.func_70681_au().nextInt(5);
                    int n5 = cj.a(this.field_70170_p, this.func_180425_c().func_177958_n() + n3, this.func_180425_c().func_177952_p() + n4);
                    this.R = new BlockPos(this.func_180425_c().func_177958_n() + n3, n5, this.func_180425_c().func_177952_p() + n4);
                    this.Y = 0;
                }
                try {
    ...
    void J() {
        ...
        do {
            ...
            double d2 = vec3d5.field_72450_a / (vec3d5.field_72450_a + vec3d5.field_72449_c);
            double d4 = vec3d5.field_72449_c / (vec3d5.field_72450_a + vec3d5.field_72449_c);
            try {
                Vec3d vec3d6;
            ...
            vec3d2((double)n2 * d2 * d, 0.0, (double)(vec3d4.field_72449_c > 0.0 ? 1 : -1) * d4 * d);
            Vec3d vec3d7 = vec3d3.func_178787_e(vec3d);
            PathNavigate pathNavigate = this.func_70661_as();
            pathNavigate.func_75499_g();
            bl = pathNavigate.func_75492_a(vec3d7.field_72450_a, vec3d7.field_72448_b, vec3d7.field_72449_c, (double)0.825f);
            d -= 1.0;
        } while (!bl);
    }
    ...
    boolean j() {
        ...
        try {
            bl = pathPoint2.field_75837_b - pathPoint.field_75837_b == 1;
        }
        catch (ConcurrentModificationException concurrentModificationException) {
            throw e3.a(concurrentModificationException);
        }
    ...
    public boolean C() {
        ...
        try {
            bl = !block.func_176205_b((IBlockAccess)this.field_70170_p, this.func_180425_c().func_177982_a(0, 1, 0));
        }
        catch (ConcurrentModificationException concurrentModificationException) {
            throw e3.a(concurrentModificationException);
        }
