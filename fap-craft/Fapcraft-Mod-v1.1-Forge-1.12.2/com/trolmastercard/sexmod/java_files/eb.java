...
fg {
    ...
    public boolean func_184645_a(EntityPlayer entityPlayer, EnumHand enumHand) {
        block12: {
            ...
            try {
                bl = itemStack.func_77973_b() == Items.field_151057_cb;
            }
            catch (RuntimeException runtimeException) {
                throw eb.a(runtimeException);
            }
            ...
            block34: {
                block31: {
                    block29: {
                        ...
                        try {
                            try {
                                entityDataManager.func_187227_b(dataParameter, (Object)bl);
                    ...
                    if (this.ay) {
                        block30: {
                            ...
                            try {
                                try {
                                    if (!(d < 0.5) && this.ak <= 200) break block30;
                                }
                                catch (RuntimeException runtimeException) {
                                    throw eb.a(runtimeException);
                                }
