...
extends Render<gi> {
    ...
    public void a(gi gi2, double d, double d2, double d3, float f, float f2) {
        ...
        try {
            ...
            n = eb2.func_184591_cq() == EnumHandSide.RIGHT ? 1 : -1;
        }
        catch (RuntimeException runtimeException) {
            throw fi.a(runtimeException);
        }
        ...
        double d5 = MathHelper.func_76126_a((float)f4);
        double d6 = MathHelper.func_76134_b((float)f4);
        double d7 = (double)n3 * 0.35;
        double d8 = eb2.field_70169_q + (eb2.field_70165_t - eb2.field_70169_q) * (double)f2 - d6 * d7 - d5 * 0.8;
        double d9 = eb2.field_70167_r + (double)eb2.func_70047_e() + (eb2.field_70163_u - eb2.field_70167_r) * (double)f2 - 0.45;
        double d10 = eb2.field_70166_s + (eb2.field_70161_v - eb2.field_70166_s) * (double)f2 - d5 * d7 + d6 * 0.8;
        try {
            d4 = eb2.func_70093_af() ? -0.1875 : 0.0;
        }
        catch (RuntimeException runtimeException) {
            throw fi.a(runtimeException);
        }
        double d11 = d4;
        double d12 = gi2.field_70169_q + (gi2.field_70165_t - gi2.field_70169_q) * (double)f2 - Math.sin((double)(eb2.I().floatValue() + 90.0f) * (Math.PI / 180)) * 0.1896224320030116 - Math.sin((double)eb2.I().floatValue() * (Math.PI / 180)) * 0.08742380916962415;
        double d13 = gi2.field_70167_r + (gi2.field_70163_u - gi2.field_70167_r) * (double)f2 + 0.25 + -0.5;
        double d14 = gi2.field_70166_s + (gi2.field_70161_v - gi2.field_70166_s) * (double)f2 + Math.cos((double)(eb2.I().floatValue() + 90.0f) * (Math.PI / 180)) * 0.1896224320030116 + Math.cos((double)eb2.I().floatValue() * (Math.PI / 180)) * 0.08742380916962415;
        double d15 = (float)(d8 - d12);
        double d16 = (double)((float)(d9 - d13)) + d11;
        ...
        if (itemStack.func_77973_b().equals(Items.field_190931_a)) {
            ...
            for (int i = 0; i <= 16; ++i) {
                ...
                bufferBuilder.func_181662_b(d + d15 * (double)f5, d2 + d16 * (double)(f5 * f5 + f5) * 0.5 + 0.25, d3 + d17 * (double)f5).func_181669_b(0, 0, 0, 255).func_181675_d();
            }
            tessellator.func_78381_a();
        }
