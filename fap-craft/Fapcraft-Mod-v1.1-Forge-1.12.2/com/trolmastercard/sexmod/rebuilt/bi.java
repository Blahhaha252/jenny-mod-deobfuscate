...
public class bi {
    public static void a() {
        ...
        EntityRegistry.addSpawn(fn.class, (int)10, (int)1, (int)1, (EnumCreatureType)EnumCreatureType.CREATURE, (Biome[])new Biome[]{Biomes.SWAMPLAND, Biomes.MUTATED_SWAMPLAND});
        EntityRegistry.addSpawn(fz.class, (int)5, (int)1, (int)1, (EnumCreatureType)EnumCreatureType.CREATURE, (Biome[])new Biome[]{Biomes.FOREST, Biomes.FOREST_HILLS});
        EntityRegistry.addSpawn(al.class, (int)3, (int)1, (int)1, (EnumCreatureType)EnumCreatureType.AMBIENT, (Biome[])new Biome[]{Biomes.HELL});
        EntityRegistry.addSpawn(f8.class, (int)5, (int)1, (int)1, (EnumCreatureType)EnumCreatureType.AMBIENT, (Biome[])new Biome[]{Biomes.HELL});
    }

    private static void b(String string, Class<? extends Entity> clazz, int n) {
        EntityRegistry.registerModEntity((ResourceLocation)new ResourceLocation("sexmod:" + string), clazz, (String)string, (int)n, (Object)Main.instance, (int)100, (int)1, (boolean)false);
    }

    private static void a(String string, Class<? extends Entity> clazz, int n, int n2, int n3) {
        EntityRegistry.registerModEntity((ResourceLocation)new ResourceLocation("sexmod:" + string), clazz, (String)string, (int)n, (Object)Main.instance, (int)50, (int)1, (boolean)true, (int)n2, (int)n3);
    }

    private static void a(String string, Class<? extends Entity> clazz, int n) {
        EntityRegistry.registerModEntity((ResourceLocation)new ResourceLocation("sexmod:" + string), clazz, (String)string, (int)n, (Object)Main.instance, (int)50, (int)1, (boolean)true);
    }
}
