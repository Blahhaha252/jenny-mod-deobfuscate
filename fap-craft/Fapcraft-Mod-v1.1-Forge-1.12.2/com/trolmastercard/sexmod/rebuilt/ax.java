...
public class ax {
    ...
    public static void a(World world, Vec3d vec3d) {
        ...
        a a2 = new a(uUID, eyeAndKoboldColor, (ff)arrayList.get(0), arrayList);
        c.put(uUID, a2);
        int n2 = 0;
    ...
    public static void c(UUID uUID, ff ff2) {
        ...
        try {
            ...
            if (!ff2.aA) {
                ff2.getDataManager().set(ff.N, (Object)a2.h.toString());
            }
        }
        catch (RuntimeException runtimeException) {
            throw ax.a(runtimeException);
    ...
    public static void k(UUID uUID) {
        block7: {
            ...
            try {
                try {
                    if (ff2 != null && !ff2.isDead) break block7;
                }
                catch (RuntimeException runtimeException) {
                    throw ax.a(runtimeException);
                }
    ...
    public static void a(UUID uUID, ff ff2) {
        ...
        block17: {
            ...
            try {
                a2.b(ff2);
                a2.b(ff2.f());
                if (a2.g == null || a2.g.getEntityId() != ff2.getEntityId()) break block17;
            }
            catch (RuntimeException runtimeException) {
                throw ax.a(runtimeException);
            }
    ...
    public static boolean e(UUID uUID, ff ff2) {
        ...
        try {
            bl = a2.g.getEntityId() == ff2.getEntityId();
        }
        catch (RuntimeException runtimeException) {
            throw ax.a(runtimeException);
        }
    ...
    public static void a(UUID uUID, boolean tribe_state) {
        a a2 = c.get(uUID);
        try {
            if (a2 == null) {
                System.out.println("tribe of UUID " + uUID.toString() + " not found uwu");
    ...
    extends WorldSavedData {
        ...
        public void a(WorldEvent.Load load) {
            ...
            world.getMapStorage().getOrLoadData(b.class, "tribes");
        }
        ...
        public void a(BlockEvent.PlaceEvent placeEvent) {
                ...
                block29: {
                    block28: {
                        block27: {
                            ...
                            type = ((BlockChest)world.getBlockState((BlockPos)blockPos2).getBlock()).chestType;
                            blockPos = null;
                            try {
                                if (!(world.getBlockState(blockPos2.north()).getBlock() instanceof BlockChest) || !type.equals((Object)((BlockChest)world.getBlockState((BlockPos)blockPos2.north()).getBlock()).chestType)) break block27;
                            }
                            catch (RuntimeException runtimeException) {
                                throw com.trolmastercard.sexmod.ax$b.a(runtimeException);
                            }
                            blockPos = blockPos2.north();
                        }
                        try {
                            if (!(world.getBlockState(blockPos2.east()).getBlock() instanceof BlockChest) || !type.equals((Object)((BlockChest)world.getBlockState((BlockPos)blockPos2.east()).getBlock()).chestType)) break block28;
                        }
                        catch (RuntimeException runtimeException) {
                            throw com.trolmastercard.sexmod.ax$b.a(runtimeException);
                        }
                        blockPos = blockPos2.east();
                    }
                    try {
                        if (!(world.getBlockState(blockPos2.south()).getBlock() instanceof BlockChest) || !type.equals((Object)((BlockChest)world.getBlockState((BlockPos)blockPos2.south()).getBlock()).chestType)) break block29;
                    }
                    catch (RuntimeException runtimeException) {
                        throw com.trolmastercard.sexmod.ax$b.a(runtimeException);
                    }
                    blockPos = blockPos2.south();
                }
                try {
                    if (!(world.getBlockState(blockPos2.west()).getBlock() instanceof BlockChest) || !type.equals((Object)((BlockChest)world.getBlockState((BlockPos)blockPos2.west()).getBlock()).chestType)) break block30;
                }
                catch (RuntimeException runtimeException) {
                    throw com.trolmastercard.sexmod.ax$b.a(runtimeException);
                }
                blockPos = blockPos2.west();
            }
            try {
                if (blockPos == null) {
                    return;
            ...
            for (Map.Entry entry : c.entrySet()) {
                ...
                EntityPlayerMP entityPlayerMP = (EntityPlayerMP)world.getPlayerEntityByUUID(uUID);
                try {
        ...
        public void a(BlockEvent.BreakEvent breakEvent) {
            ...
            if (block instanceof BlockChest) {
                for (Map.Entry entry : c.entrySet()) {
                    ...
                    object = (EntityPlayerMP)world.getPlayerEntityByUUID((UUID)object2);
                    try {
                        if (object == null) {
                            continue;
                        }
            ...
            if (block instanceof BlockBed) {
                for (Map.Entry entry : c.entrySet()) {
                    ...
                    EntityPlayerMP entityPlayerMP = (EntityPlayerMP)world.getPlayerEntityByUUID((UUID)object);
                    try {
                        if (entityPlayerMP == null) {
                            continue;
                        }
        ...
        public NBTTagCompound writeToNBT(NBTTagCompound nBTTagCompound) {
            ...
            for (Map.Entry entry : c.entrySet()) {
                ...
                try {
                    ...
                    nBTTagCompound.setString("tribeColor" + n2, a2.h.toString());
                    if (uUID2 != null) {
    ...
    public static class a {
        ...
        public boolean e() {
            return this.tribe_state
        }
        public boolean a(tribe_state) {
            this.tribe_state = tribe_state
        }
