...
lbl16:
    ...
    public static em c(@Nonnull UUID uUID) {
        ...
        try {
            for (em em2 : em.ad()) {
                boolean bl2;
                if (em2.field_70128_L || (bl2 = em2.field_70170_p.field_72995_K) != bl || !uUID.equals(em2.ae())) continue;
                return em2;
            }
            return null;
        }
...
lbl-1000:
    ...
    public MatrixStack a(String string, boolean bl) {
        ...
        if (this.Q()) {
            ...
            geoBone2.rotateY((float)(-Math.toRadians(b6.a(this.field_70760_ar, this.field_70761_aq, Minecraft.func_71410_x().func_184121_ak()))));
        }
