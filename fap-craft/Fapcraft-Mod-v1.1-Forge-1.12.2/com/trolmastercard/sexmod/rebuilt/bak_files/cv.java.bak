...
implements gs {
    ...
    public void a(T t, Integer n, AnimationEvent animationEvent) {
        ...
        if (((em)((Object)t)).C != null) {
            ((em)((Object)t)).C.transitionLengthTicks = ((em)((Object)t)).field_70170_p instanceof gj || ((em)((Object)t)).y() == null ? 5.0 : (double)((em)((Object)t)).y().transitionTick;
        }
    ...
    public static Vec3d a(Vec3d vec3d, Vec3d vec3d2) {
        ...
        double d = vec3d4.field_72450_a / (vec3d4.field_72450_a + vec3d4.field_72448_b + vec3d4.field_72449_c);
        double d2 = vec3d4.field_72448_b / (vec3d4.field_72450_a + vec3d4.field_72448_b + vec3d4.field_72449_c);
        double d3 = vec3d4.field_72449_c / (vec3d4.field_72450_a + vec3d4.field_72448_b + vec3d4.field_72449_c);
        Vec3d vec3d5 = new Vec3d((double)(vec3d3.field_72450_a > 0.0 ? 1 : -1) * d, (double)(vec3d3.field_72448_b > 0.0 ? 1 : -1) * d2, (double)(vec3d3.field_72449_c > 0.0 ? 1 : -1) * d3);
        double d4 = vec3d5.field_72448_b / 2.0 + 0.5;
