    ...
    implements IMessageHandler<gh, IMessage> {
        public IMessage a(gh gh2, MessageContext messageContext) {
            ...
            if (messageContext.side.isClient()) {
                Minecraft.getMinecraft().player.sendMessage((ITextComponent)new TextComponentString(gh2.a));
            } else {
                FMLCommonHandler.instance().getMinecraftServerInstance().addScheduledTask(() -> {
                    Vec3d vec3d = em.g(gh2.c).get(0).M();
                    ge.b.sendToAllAround((IMessage)new gh(gh2.a, gh2.d, gh2.c), new NetworkRegistry.TargetPoint(gh2.d, vec3d.x, vec3d.y, vec3d.z, 40.0));
                });
            }
            return null;
        }
