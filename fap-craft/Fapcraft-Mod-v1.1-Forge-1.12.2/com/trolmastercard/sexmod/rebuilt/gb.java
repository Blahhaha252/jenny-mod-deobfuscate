...
extends Gui {
    ...
    public void a(RenderGameOverlayEvent renderGameOverlayEvent) {
            ...
            block28: {
                ...
                block27: {
                    block26: {
                            ...
                            block24: {
                                ...
                                block23: {
                                    block22: {
                                        ...
                                        n8 = renderGameOverlayEvent.getResolution().getScaledWidth();
                                        int n21 = renderGameOverlayEvent.getResolution().getScaledHeight();
                                        float f = renderGameOverlayEvent.getPartialTicks();
                                        e.getTextureManager().bindTexture(l);
                                        d = c ? 1.0 - b6.d((gb.d + f) / 20.0f) : Math.min(1.0, b6.c((j + f) / 20.0f));
                                        n7 = n21 + 385;
                                        ...
                                        try {
                                            try {
                                                this.drawTexturedModalRect(n8 / 2 - 87, (int)b6.b((double)n6, (double)n7, d), 0, 104, 174, 48);
                                                gb5 = this;
                                                n20 = (int)((float)n8 / 2.0f - 78.0f);
                                                n19 = (int)b6.b((double)n6, (double)(n7 - 52), d);
                                                n18 = 52;
                                ...
                                try {
                                    try {
                                        gb5.drawTexturedModalRect(n20, n19, n18, n17, 52, 52);
                                        gb4 = this;
                                        n16 = (int)((float)n8 / 2.0f - 26.0f);
                                        n15 = (int)b6.b((double)n6, (double)(n7 - 52), d);
                                        n14 = 104;
                        ...
                        try {
                            try {
                                gb4.drawTexturedModalRect(n16, n15, n14, n13, 52, 52);
                                gb3 = this;
                                n12 = (int)((float)n8 / 2.0f + 26.0f);
                                n11 = (int)b6.b((double)n6, (double)(n7 - 52), d);
                                n10 = 156;
                ...
                try {
                    try {
                        gb3.drawTexturedModalRect(n12, n11, n10, n9, 52, 52);
                        gb2 = this;
                        n5 = (int)((float)n8 / 2.0f - 26.0f);
                        n4 = (int)b6.b((double)n6, (double)(n7 - 104), d);
                        n3 = 0;
        ...
        gb2.drawTexturedModalRect(n5, n4, n3, n2, 52, 52);
        this.drawTexturedModalRect(n8 / 2 - 87 + 8, (int)b6.b((double)(n6 - 8), (double)(n7 + 8), d), 8, 152, (int)(158.0f * k), 32);
