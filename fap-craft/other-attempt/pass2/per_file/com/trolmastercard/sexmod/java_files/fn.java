...
extends em {
    ...
    void d() {
        block1: {
            int n = (Integer)this.m.func_187225_a(U);
            if (n == -1) {
                return;
            }
    ...
    void c() {
        ...
        this.m.func_187227_b(U, (Object)(n - 1));
        if (--n >= 0) {
            return;
        }
    ...
    void b() {
        if (this.field_70170_p.field_72995_K) {
            ...
            this.field_70177_z = f = ((Float)this.m.func_187225_a(R)).floatValue();
            ...
            if (!this.K && this.field_70122_E) {
                boolean bl = this.V = (Integer)this.m.func_187225_a(U) == -1 && this.func_70681_au().nextFloat() < 0.1f;
            }
            if (this.V && this.N == 50) {
                int n2 = (Integer)this.m.func_187225_a(T);
                int n3 = n2 + 1;
    ...
    public void registerControllers(AnimationData animationData) {
        AnimationController.ISoundListener iSoundListener = soundKeyframeEvent -> {
            switch (soundKeyframeEvent.sound) {
                ...
                case "doggyslowMSG1": {
                    this.a(com.trolmastercard.sexmod.c.a(com.trolmastercard.sexmod.c.MISC_POUNDING), 0.33f);
                    int n = com.trolmastercard.sexmod.r.f.nextInt(4);
                    if (n == 0) {
                        n = com.trolmastercard.sexmod.r.f.nextInt(2);
                        if (n == 0) {
                            this.a(SoundEvents.field_187882_fq);
                        } else {
                            this.a(SoundEvents.field_187886_fs);
                ...
                case "doggyfastMSG1": {
                    ...
                    ++this.P;
                    if (this.P % 2 == 0) {
                        int n = com.trolmastercard.sexmod.r.f.nextInt(2);
                        if (n == 0) {
                            this.a(SoundEvents.field_187882_fq);
                            break;
                        }
