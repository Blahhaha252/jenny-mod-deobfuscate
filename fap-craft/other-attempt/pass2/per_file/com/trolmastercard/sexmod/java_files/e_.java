...
public class e_ {
    ...
    @SideOnly(value=Side.CLIENT)
    public static void a(ei ei2, EntityPlayer entityPlayer, double d, double d2, double d3, float f) {
        ...
        double d4 = entityPlayer.field_70142_S - entityPlayer.field_70165_t;
        double d5 = entityPlayer.field_70161_v - entityPlayer.field_70136_U;
        double d6 = Math.PI / 180 * (double)entityPlayer.field_70177_z;
        ei2.ao = new Vector2f((float)(d4 * Math.cos(d6) + d5 * Math.sin(d6)), (float)(d4 * Math.sin(d6) + d5 * Math.cos(d6)));
        float f2 = ei2.z() ? e_.a(ei2, entityPlayer) : 0.0f;
        dm.v = true;
        renderManager.func_188391_a((Entity)ei2, d, d2 + (double)f2, d3, 90.0f, f, false);
    }
    ...
    public void a(TickEvent.RenderTickEvent renderTickEvent) {
        block11: {
            ...
            if (!(minecraft.field_71439_g.field_70177_z < f - 90.0f)) break block11;
            minecraft.field_71439_g.field_70177_z = f - 90.0f;
            minecraft.field_71439_g.field_70126_B = f - 90.0f;
        }
    }
