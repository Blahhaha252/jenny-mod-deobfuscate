...
extends fo {
    ...
    public void func_70619_bc() {
        super.func_70619_bc();
        if (this.func_70644_a(co.b) && this.N < 4800.0f && this.ae() == null) {
    ...
    void b() {
        block1: {
            ...
            double d = this.field_70163_u - (double)blockPos.func_177956_o();
            if (!(d > 3.0) || !(this.field_70181_x > 0.0)) break block1;
    ...
    void a() {
        ...
        ++this.P;
        if (((Boolean)this.m.func_187225_a(M)).booleanValue()) {
            if (this.P < 40) {
            ...
            for (EntityPlayer entityPlayer : this.field_70170_p.field_73010_i) {
                if (!(entityPlayer.func_70032_d((Entity)this) < 15.0f)) continue;
                ((EntityPlayerMP)entityPlayer).field_71135_a.func_147359_a((Packet)new SPacketParticles((Boolean)this.m.func_187225_a(M) != false ? EnumParticleTypes.HEART : EnumParticleTypes.VILLAGER_ANGRY, true, (float)this.field_70165_t, (float)this.field_70163_u + 0.3f, (float)this.field_70161_v, 0.2f, 0.3f, 0.2f, 0.25f, 3, new int[0]));
            }
        } else {
            this.P = 0;
        }
    ...
    public void func_70071_h_() {
        block0: {
            super.func_70071_h_();
            if (!(this.N < 4800.0f) || this.field_70122_E || !(this.field_70181_x < 0.0)) break block0;
            this.field_70181_x *= 0.4;
        }
    }

    public void func_180430_e(float f2, float f4) {
    }

    protected boolean func_184645_a(EntityPlayer entityPlayer, EnumHand enumHand) {
        block1: {
            if (((Boolean)this.m.func_187225_a(M)).booleanValue() && !((Boolean)this.m.func_187225_a(K)).booleanValue() && entityPlayer.func_184586_b(enumHand).func_77973_b() == Item.func_150898_a((Block)Blocks.field_150486_ae)) {
                this.m.func_187227_b(K, (Object)true);
                entityPlayer.func_184586_b(enumHand).func_190918_g(1);
                return super.func_184645_a(entityPlayer, enumHand);
            }
            if (!this.field_70170_p.field_72995_K || !((Boolean)this.m.func_187225_a(M)).booleanValue()) break block1;
            this.b(entityPlayer);
        }
        return super.func_184645_a(entityPlayer, enumHand);
    }
    ...
    protected <E extends IAnimatable> PlayState a(AnimationEvent<E> animationEvent) {
        ...
        block4 : switch (animationEvent.getController().getName()) {
            case "movement": {
                ...
                this.a("animation.bee." + ((Boolean)this.m.func_187225_a(K) != false ? "idle_has_chest" : "idle"), true, animationEvent);
                break;
            }
            case "action": {
                switch (this.y()) {
