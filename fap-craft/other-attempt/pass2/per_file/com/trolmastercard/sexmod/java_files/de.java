...
extends d9 {
    ...
    @Override
    protected void d() {
        float f = 0.25f - ((Float)this.j.func_184212_Q().func_187225_a(e7.aA)).floatValue();
    ...
    protected void a(boolean bl, ItemStack itemStack) {
        ...
        GlStateManager.func_179114_b((float)(bl ? 80.0f : 180.0f), (float)1.0f, (float)0.0f, (float)0.0f);
    }
