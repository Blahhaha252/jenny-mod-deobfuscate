...
public class ax {
    ...
    public static void c(UUID uUID, ff ff2) {
        block1: {
            ...
            ff2.func_184212_Q().func_187227_b(ff.N, (Object)a$a2.h.toString());
        }
    }
    ...
    public static void a(UUID uUID, ff ff2) {
        ...
        a$a2.b(ff2);
        a$a2.b(ff2.f());
        if (a$a2.g != null && a$a2.g.func_145782_y() == ff2.func_145782_y() && (object = a$a2.b()) != null) {
            a$a2.g = object;
        }
    ...
    public static boolean e(UUID uUID, ff ff2) {
        ...
        return a$a2.g.func_145782_y() == ff2.func_145782_y();
    }
    ...
    extends WorldSavedData {
        ...
        public void a(WorldEvent.Load load) {
            ...
            world.func_175693_T().func_75742_a(b$b.class, "tribes");
        }
        ...
        public void a(BlockEvent.PlaceEvent placeEvent) {
            ...
            BlockChest.Type type = ((BlockChest)world.func_180495_p((BlockPos)blockPos).func_177230_c()).field_149956_a;
            BlockPos blockPos2 = null;
            if (world.func_180495_p(blockPos.func_177978_c()).func_177230_c() instanceof BlockChest && type.equals((Object)((BlockChest)world.func_180495_p((BlockPos)blockPos.func_177978_c()).func_177230_c()).field_149956_a)) {
                blockPos2 = blockPos.func_177978_c();
            }
            if (world.func_180495_p(blockPos.func_177974_f()).func_177230_c() instanceof BlockChest && type.equals((Object)((BlockChest)world.func_180495_p((BlockPos)blockPos.func_177974_f()).func_177230_c()).field_149956_a)) {
                blockPos2 = blockPos.func_177974_f();
            }
            if (world.func_180495_p(blockPos.func_177968_d()).func_177230_c() instanceof BlockChest && type.equals((Object)((BlockChest)world.func_180495_p((BlockPos)blockPos.func_177968_d()).func_177230_c()).field_149956_a)) {
                blockPos2 = blockPos.func_177968_d();
            }
            if (world.func_180495_p(blockPos.func_177976_e()).func_177230_c() instanceof BlockChest && type.equals((Object)((BlockChest)world.func_180495_p((BlockPos)blockPos.func_177976_e()).func_177230_c()).field_149956_a)) {
                blockPos2 = blockPos.func_177976_e();
            }
            if (blockPos2 == null) {
                return;
            ...
            for (Map.Entry entry : c.entrySet()) {
                ...
                if (uUID == null || (entityPlayerMP = (EntityPlayerMP)world.func_152378_a(uUID)) == null) continue;
        ...
        public void a(BlockEvent.BreakEvent breakEvent) {
            ...
            if (block instanceof BlockChest) {
                for (Map.Entry entry : c.entrySet()) {
                    ...
                    if (object2 == null || (object = (EntityPlayerMP)world.func_152378_a((UUID)object2)) == null) continue;
            ...
            if (block instanceof BlockBed) {
                for (Map.Entry entry : c.entrySet()) {
                    ...
                    if (object == null || (entityPlayerMP = (EntityPlayerMP)world.func_152378_a((UUID)object)) == null) continue;
                    HashSet<BlockPos> hashSet = new HashSet<BlockPos>();
        ...
        public NBTTagCompound func_189551_b(NBTTagCompound nBTTagCompound) {
            ...
            for (Map.Entry entry : c.entrySet()) {
                ...
                nBTTagCompound.func_74778_a("tribeColor" + n2, a$a2.h.toString());
                if (uUID2 != null) {
                ...
                for (ff iterator2 : a$a2.a) {
                    if (iterator2.field_70128_L) continue;
