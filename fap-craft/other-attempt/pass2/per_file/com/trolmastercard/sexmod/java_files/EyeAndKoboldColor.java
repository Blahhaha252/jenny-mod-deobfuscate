...
public enum EyeAndKoboldColor {
    ...
    private EyeAndKoboldColor(int n2, int n3, int n4, int n5, int n6, int n7, int n8, TextFormatting textFormatting) {
    ...
    public static EyeAndKoboldColor getColorByWoolId(int n) {
        for (EyeAndKoboldColor eyeAndKoboldColor : EyeAndKoboldColor.values()) {
            if (eyeAndKoboldColor.getWoolMeta() != n) continue;
            return eyeAndKoboldColor;
        }
        return ff.aJ;
    }
