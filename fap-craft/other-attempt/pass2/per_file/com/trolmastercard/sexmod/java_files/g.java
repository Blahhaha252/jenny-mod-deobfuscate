...
extends f {
    ...
    protected void a(f.a.a a2) {
        switch (a2) {
            case ATTACK: {
                ...
                double d = this.q.func_70032_d((Entity)this.r);
                this.c.func_75499_g();
                if (d < 1.9 && --this.k <= 0) {
                    this.d();
                    break;
                }
                if (this.q.Q.getStackInSlot(1).func_77973_b() instanceof ItemBow && this.q.func_70635_at().func_75522_a((Entity)this.r) && ++this.p > 0 && d > 6.0) {
            ...
            case FOLLOW: {
                ...
                double d = this.q.func_70032_d((Entity)this.a);
    ...
    protected f.a.a a() {
        ...
        if (this.f != f.a.a.FOLLOW) {
            ...
            list.sort((entityMob, entityMob2) -> {
                double d;
                double d2 = entityMob.func_70032_d((Entity)this.q);
                if (d2 == (d = (double)entityMob2.func_70032_d((Entity)this.q))) {
                    return 0;
                }
                return d2 < d ? -1 : 1;
            });
        ...
        boolean bl2 = bl = (f2 = this.q.func_70032_d((Entity)this.a)) > 5.0f;
        if (!bl && this.f == f.a.a.FOLLOW) {
            if (++this.m > 60) {
                bl = false;
                this.m = 0;
            } else {
    ...
    public void e() {
        ...
        double d = this.r.field_70165_t - this.q.field_70165_t;
        double d2 = this.r.func_174813_aQ().field_72338_b + (double)(this.r.field_70131_O / 3.0f) - entityArrow.field_70163_u;
        double d3 = this.r.field_70161_v - this.q.field_70161_v;
        double d4 = MathHelper.func_76133_a((double)(d * d + d3 * d3));
        entityArrow.func_70186_c(d, d2 + d4 * (double)0.2f, d3, 1.6f, 2.0f);
    ...
    protected EntityArrow b() {
        ...
        block2: {
            ...
            double d = EnchantmentHelper.func_77506_a((Enchantment)Enchantments.field_185309_u, (ItemStack)itemStack);
            int n = EnchantmentHelper.func_77506_a((Enchantment)Enchantments.field_185310_v, (ItemStack)itemStack);
            int n2 = EnchantmentHelper.func_77506_a((Enchantment)Enchantments.field_185311_w, (ItemStack)itemStack);
            if (d != 0.0) {
                entityTippedArrow.func_70239_b(entityTippedArrow.func_70242_d() + d * 0.5 + 0.5);
            }
            if (n != 0) {
                entityTippedArrow.func_70240_a(n);
            }
    ...
    void d() {
        ...
        for (AttributeModifier attributeModifier : multimap.get((Object)SharedMonsterAttributes.field_188790_f.func_111108_a())) {
            f3 = (float)attributeModifier.func_111164_d();
        }
        f3 = Math.max(f3, 0.5f);
        float f4 = EnchantmentHelper.func_152377_a((ItemStack)itemStack, (EnumCreatureAttribute)this.r.func_70668_bt());
        int n = EnchantmentHelper.func_77506_a((Enchantment)Enchantments.field_180313_o, (ItemStack)itemStack);
        int n2 = EnchantmentHelper.func_77506_a((Enchantment)Enchantments.field_77334_n, (ItemStack)itemStack);
        int n3 = EnchantmentHelper.func_77506_a((Enchantment)Enchantments.field_191530_r, (ItemStack)itemStack);
        this.r.func_70653_a((Entity)this.q, (float)n * 0.5f, (double)MathHelper.func_76126_a((float)(this.q.field_70177_z * ((float)Math.PI / 180))), (double)(-MathHelper.func_76134_b((float)(this.q.field_70177_z * ((float)Math.PI / 180)))));
        this.r.func_70015_d(n2 * 4);
        if (n3 != 0) {
            float f5 = 0.5f;
            if (n3 == 2) {
                f5 = 0.67f;
            ...
            for (EntityLivingBase entityLivingBase : this.q.field_70170_p.func_72872_a(EntityLivingBase.class, this.r.func_174813_aQ().func_72314_b(1.0, 0.25, 1.0))) {
                ...
                entityLivingBase.func_70097_a(DamageSource.func_76358_a((EntityLivingBase)this.q), (f2 + f4) * f5);
            }
        }
        this.r.func_70097_a(DamageSource.func_76358_a((EntityLivingBase)this.q), f2 + f4);
        this.k = Math.round(Math.abs(f3) / 3.373494f * 20.0f);
    }
