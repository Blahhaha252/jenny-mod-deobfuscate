...
implements IMessage {
    ...
    public h6(HashSet<BlockPos> hashSet, boolean bl) {
        this.c = hashSet;
        this.a = bl;
    }

    public h6(BlockPos blockPos, boolean bl) {
        this.c.add(blockPos);
        this.a = bl;
    }
            ...
            FMLCommonHandler.instance().getMinecraftServerInstance().func_152344_a(() -> {
                ...
                for (BlockPos blockPos : h62.c) {
                    ...
                    if (iBlockState.func_177230_c() instanceof BlockChest) {
                        ...
                        if (world.func_180495_p(blockPos.func_177978_c()).func_177230_c() instanceof BlockChest && object.equals((Object)((BlockChest)world.func_180495_p((BlockPos)blockPos.func_177978_c()).func_177230_c()).field_149956_a)) {
                            blockPos2 = blockPos.func_177978_c();
                        }
                        if (world.func_180495_p(blockPos.func_177974_f()).func_177230_c() instanceof BlockChest && object.equals((Object)((BlockChest)world.func_180495_p((BlockPos)blockPos.func_177974_f()).func_177230_c()).field_149956_a)) {
                            blockPos2 = blockPos.func_177974_f();
                        }
                        if (world.func_180495_p(blockPos.func_177968_d()).func_177230_c() instanceof BlockChest && object.equals((Object)((BlockChest)world.func_180495_p((BlockPos)blockPos.func_177968_d()).func_177230_c()).field_149956_a)) {
                            blockPos2 = blockPos.func_177968_d();
                        }
                        if (world.func_180495_p(blockPos.func_177976_e()).func_177230_c() instanceof BlockChest && object.equals((Object)((BlockChest)world.func_180495_p((BlockPos)blockPos.func_177976_e()).func_177230_c()).field_149956_a)) {
                            blockPos2 = blockPos.func_177976_e();
                        }
                    }
                    if (blockPos2 == null && iBlockState.func_177230_c() instanceof BlockBed) {
                        return;
                    }
                    if (h62.a) {
                        if (iBlockState.func_177230_c() instanceof BlockBed) {
