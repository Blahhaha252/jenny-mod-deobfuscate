...
extends Render<al> {
    ...
    public void a(al al2, double d, double d2, double d3, float f, float f2) {
        ...
        Vec3d vec3d = b6.a(new Vec3d(al2.field_70142_S, al2.field_70137_T, al2.field_70136_U), al2.func_174791_d(), (double)f2);
        ...
        ResourceLocation resourceLocation = this.a(al2, Math.abs(vec3d3.field_72450_a) + Math.abs(vec3d3.field_72448_b) + Math.abs(vec3d3.field_72449_c));
        this.d.field_71446_o.func_110577_a(resourceLocation);
        GlStateManager.func_179094_E();
        GlStateManager.func_179131_c((float)1.0f, (float)1.0f, (float)1.0f, (float)this.b(al2, f2));
        ...
        if (this.k != com.trolmastercard.sexmod.e.f && resourceLocation == com.trolmastercard.sexmod.e.f && l > this.i + 60000L) {
    ...
    ResourceLocation a(al al2, double d) {
        if (al2.a != -1) {
        ...
        return Math.sin((float)this.d.field_71439_g.field_70173_aa * 0.75f) > 0.0 ? a : b;
    }

    double a(ResourceLocation resourceLocation) {
        if (!a.equals((Object)resourceLocation) && !b.equals((Object)resourceLocation)) {
            return 0.0;
        }
    ...
    float b(al al2, float f) {
        ...
        int n = 90;
        float f2 = be.b(this.d.field_71439_g.field_70173_aa - al2.a, n, 120.0f) - (float)n;
        float f3 = (f2 + f) / 30.0f;
        return 1.0f - f3;
    }
