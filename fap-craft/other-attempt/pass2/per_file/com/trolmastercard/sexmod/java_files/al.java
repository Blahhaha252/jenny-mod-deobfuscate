...
extends EntityLiving {
    ...
    void a() {
        ...
        if (entityPlayer != null && entityPlayer.func_70032_d((Entity)this) < 3.0f) {
            this.func_70661_as().func_75499_g();
            return;
        }
        if (this.f == null || this.func_70011_f(this.f.func_177958_n(), this.f.func_177956_o(), this.f.func_177952_p()) > this.c() || this.d > 175) {
            int n = (this.func_70681_au().nextBoolean() ? 1 : -1) * this.func_70681_au().nextInt(10);
            int n2 = (this.func_70681_au().nextBoolean() ? 1 : -1) * this.func_70681_au().nextInt(10);
            int n3 = this.field_70170_p.field_73011_w.func_186058_p() == DimensionType.NETHER ? (int)Math.ceil(this.field_70163_u) : cj.a(this.field_70170_p, this.func_180425_c().func_177958_n() + n, this.func_180425_c().func_177952_p() + n2);
            this.f = new BlockPos(this.func_180425_c().func_177958_n() + n, n3, this.func_180425_c().func_177952_p() + n2);
            this.d = 0;
        }
        if (Math.sqrt(this.f.func_177951_i((Vec3i)this.func_180425_c())) > 2.0) {
    ...
    protected void d() {
        ...
        int n = path.func_75873_e();
        int n2 = path.func_75874_d();
        if (n2 == n || n2 - 1 == n) {
            return;
        }
        PathPoint pathPoint = path.func_75877_a(n);
        PathPoint pathPoint2 = path.func_75877_a(n + 1);
