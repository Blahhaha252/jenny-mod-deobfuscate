...
extends d_<f8> {
    ...
    public static void a(em em2, String string, GeoBone geoBone, boolean bl) {
        ...
        if (be.a((double)n, 17.0, 35.0)) {
            ...
            if ((f = gc.d(em2.b().getBone(string2).getRotationX())) < 0.0f) {
                return;
            }
            geoBone.setPositionY(geoBone.getPositionY() + f * 0.01f);
        }
        if (be.a((double)n, 1.0, 11.0)) {
    ...
    @Override
    protected void a(GeoModel geoModel, BufferBuilder bufferBuilder, f8 f82, float f, float f3, float f4, float f5, float f6) {
        if (!ce.c(f82)) {
            super.a(geoModel, bufferBuilder, f82, f, f3, f4, f5, f6);
            return;
        }
        ...
        this.renderRecursively(bufferBuilder, geoBone3, f, f3, f4, ((f8)this.j).v());
        Tessellator.func_178181_a().func_78381_a();
        MATRIX_STACK.pop();
    }
    ...
    public static void a(f_ f_2, float f, EntityLivingBase entityLivingBase) {
        boolean bl = f_2.Q();
        float f3 = bl ? f_2.I().floatValue() : f_2.field_70759_as;
        float f4 = bl ? f_2.I().floatValue() : f_2.field_70758_at;
        Float f5 = f_.a(f_2, f);
        if (f5 != null) {
            f3 = f5.floatValue();
            f4 = f5.floatValue();
        ...
        entityLivingBase.field_70760_ar = f4;
