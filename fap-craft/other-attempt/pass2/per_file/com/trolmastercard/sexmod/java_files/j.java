...
extends GuiScreen {
    ...
    public void func_73863_a(int n2, int n3, float f) {
        ...
        this.func_175174_a(-62.0f + f4 - this.k * 15.0f, -62.0f + f4 - this.k * 15.0f, 0, 0, 64, 64);
        this.c(f4);
        if (d) {
            this.func_175174_a(-62.0f + f4 - this.k * 15.0f, -62.0f + f4 - this.k * 15.0f, 128, 64, 64, 64);
        }
        GlStateManager.func_179121_F();
        GlStateManager.func_179094_E();
        GlStateManager.func_179152_a((float)(1.0f + this.n * 0.5f), (float)(1.0f + this.n * 0.5f), (float)1.0f);
        this.func_175174_a(-2.0f - f4 + this.n * 15.0f, -2.0f - f4 + this.n * 15.0f, 0, 0, 64, 64);
        this.a(f4);
        if (fa.b()) {
            this.func_175174_a(-2.0f - f4 + this.n * 15.0f, -2.0f - f4 + this.n * 15.0f, 128, 64, 64, 64);
        }
        GlStateManager.func_179121_F();
        Block block = this.e.func_177230_c();
        ...
        if (bl2 || bl3) {
            ...
            this.func_175174_a(-62.0f + f4 - this.a * 15.0f, -2.0f - f4 + this.a * 15.0f, 0, 0, 64, 64);
            if (bl2) {
                this.d(f4);
            }
            if (bl3) {
            ...
            if (gm.a(this.c)) {
                this.func_175174_a(-62.0f + f4 - this.a * 15.0f, -2.0f - f4 + this.a * 15.0f, 128, 64, 64, 64);
            }
            GlStateManager.func_179121_F();
        }
        ...
        if (bl4 || bl) {
            ...
            this.func_175174_a(-2.0f - f4 + this.i * 15.0f, -62.0f + f4 - this.i * 15.0f, 0, 0, 64, 64);
            if (bl4) {
                this.e(f4);
            }
            if (bl) {
            ...
            if (gm.a(this.c)) {
                this.func_175174_a(-2.0f - f4 + this.i * 15.0f, -62.0f + f4 - this.i * 15.0f, 128, 64, 64, 64);
            }
            GlStateManager.func_179121_F();
        }
        GlStateManager.func_179121_F();
