...
extends WorldSavedData {
    ...
    void a(NBTTagCompound nBTTagCompound, String string, List<BlockPos> list) {
        ...
        for (BlockPos blockPos : list) {
            nBTTagCompound.func_74768_a("sexmod:x" + string + n, blockPos.func_177958_n());
            nBTTagCompound.func_74768_a("sexmod:y" + string + n, blockPos.func_177956_o());
            nBTTagCompound.func_74768_a("sexmod:z" + string + n, blockPos.func_177952_p());
            ++n;
        }
    }
    ...
    void b(NBTTagCompound nBTTagCompound, String string, List<BlockPos> list) {
        list.clear();
        int n = nBTTagCompound.func_74762_e("sexmod:pos_amount" + string);
        for (int i = 0; i < n; ++i) {
            list.add(new BlockPos(nBTTagCompound.func_74762_e("sexmod:x" + string + i), nBTTagCompound.func_74762_e("sexmod:y" + string + i), nBTTagCompound.func_74762_e("sexmod:z" + string + i)));
        }
    }
