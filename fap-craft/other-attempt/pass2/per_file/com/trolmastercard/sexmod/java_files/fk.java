...
public class fk {
    public static void a() {
        RenderingRegistry.registerEntityRenderingHandler(ff.class, renderManager -> new dj(renderManager, new c9(), -0.4));
        ...
        RenderingRegistry.registerEntityRenderingHandler(fn.class, renderManager -> new d1(renderManager, new cr(), -0.2));
        RenderingRegistry.registerEntityRenderingHandler(e0.class, renderManager -> new dt(renderManager, new cl(), -0.4));
        RenderingRegistry.registerEntityRenderingHandler(ev.class, renderManager -> new d8(renderManager, new c2(), -0.4));
        ...
        RenderingRegistry.registerEntityRenderingHandler(eb.class, renderManager -> new dp(renderManager, new cg(), -0.4));
        RenderingRegistry.registerEntityRenderingHandler(e3.class, renderManager -> new dy(renderManager, new ci(), -0.6));
        RenderingRegistry.registerEntityRenderingHandler(f_.class, renderManager -> new da(renderManager, new cb(), -0.05));
        RenderingRegistry.registerEntityRenderingHandler(i.class, renderManager -> new cp(renderManager, new k()));
        RenderingRegistry.registerEntityRenderingHandler(f8.class, renderManager -> new dh(renderManager, new ce(), -0.05));
        RenderingRegistry.registerEntityRenderingHandler(eg.class, renderManager -> new d0(renderManager, new cl()));
        RenderingRegistry.registerEntityRenderingHandler(es.class, renderManager -> new db(renderManager, new c5()));
        RenderingRegistry.registerEntityRenderingHandler(ee.class, renderManager -> new dl(renderManager, new cx()));
        RenderingRegistry.registerEntityRenderingHandler(ec.class, renderManager -> new d5(renderManager, new cr()));
        RenderingRegistry.registerEntityRenderingHandler(e5.class, renderManager -> new dv(renderManager, new c2()));
        RenderingRegistry.registerEntityRenderingHandler(e9.class, renderManager -> new d2(renderManager, new c0()));
        RenderingRegistry.registerEntityRenderingHandler(ed.class, renderManager -> new di(renderManager, new cg()));
        RenderingRegistry.registerEntityRenderingHandler(e7.class, renderManager -> new de(renderManager, new c9()));
        RenderingRegistry.registerEntityRenderingHandler(eq.class, renderManager -> new dg(renderManager, new ci()));
        RenderingRegistry.registerEntityRenderingHandler(er.class, renderManager -> new dx(renderManager, new cb()));
