...
extends EntityLiving {
    ...
    void a(double d, double d2, double d3) {
        ...
        this.field_70170_p.func_175688_a(EnumParticleTypes.DRAGON_BREATH, d + random.nextDouble() * (double)0.3f, d2 + 0.25 + random.nextDouble() * (double)0.3f, d3 + random.nextDouble() * (double)0.3f, 0.0, 0.0, 0.0, new int[0]);
    }
    ...
    boolean b(Vec3d vec3d) {
        ...
        return entityLivingBase.func_70011_f(vec3d.field_72450_a, vec3d.field_72448_b, vec3d.field_72449_c) < 15.0;
    }
    ...
    public static void a(Vec3d vec3d) {
        ...
        Random random = r.f;
        float f4 = 0.0f;
        while ((double)f4 < Math.PI * 2) {
            double d = Math.sin(f4);
            double d2 = Math.cos(f4);
            double d3 = vec3d.field_72450_a + d * 0.5;
            double d4 = d * (double)0.15f;
            double d5 = vec3d.field_72449_c + d2 * 0.5;
    ...
    public boolean func_70097_a(DamageSource damageSource, float f) {
        ...
        if (!this.field_70170_p.field_72995_K && "arrow".equals(damageSource.field_76373_n)) {
            this.func_70606_j(0.0f);
            this.i = false;
