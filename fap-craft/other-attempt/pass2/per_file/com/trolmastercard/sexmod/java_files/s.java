...
implements IMessage {
    ...
    implements IMessageHandler<s, IMessage> {
        public static void a(em em2) {
            ...
            World world;
            em2.g();
            if (em2 instanceof ei && em2.field_70170_p.func_152378_a(((ei)em2).m()) != null) {
                ...
                em2.a(false);
                em2.b(fp.NULL);
                if (em2.ae() != null && (vec3d = em2.field_70170_p.func_152378_a(em2.ae())) != null) {
        ...
        public IMessage a(s s2, MessageContext messageContext) {
            if (!s2.b || messageContext.side != Side.SERVER) {
            ...
            FMLCommonHandler.instance().getMinecraftServerInstance().func_152344_a(() -> {
                ...
                for (em em2 : arrayList) {
                    ...
                    if (em2.ae() != null) {
                        a$a.a(FMLCommonHandler.instance().getMinecraftServerInstance().func_184103_al().func_177451_a(em2.ae()));
                    }
                    if (s2.a) continue;
                    a$a.a(em2);
                }
