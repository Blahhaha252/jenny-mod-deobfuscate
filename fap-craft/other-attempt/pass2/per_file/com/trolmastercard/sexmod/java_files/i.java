...
implements IAnimatable {
    ...
    private final AnimationFactory d = new AnimationFactory((IAnimatable)this);
    public UUID f = null;
    ...
    public void func_70071_h_() {
        block1: {
            super.func_70071_h_();
            int n = (Integer)this.field_70180_af.func_187225_a(c);
            if (n >= 12000) {
                this.a();
            }
            if (this.field_70170_p.field_72995_K) break block1;
            this.field_70180_af.func_187227_b(c, (Object)(n + 1));
        }
    }
    ...
    void a() {
        for (int j = 0; j < 30; ++j) {
            float f = (float)(r.f.nextBoolean() ? 1 : -1) * r.f.nextFloat();
            float f2 = (float)(r.f.nextBoolean() ? 1 : -1) * r.f.nextFloat();
            float f3 = (float)(r.f.nextBoolean() ? 1 : -1) * r.f.nextFloat();
            this.field_70170_p.func_175688_a(EnumParticleTypes.EXPLOSION_NORMAL, 0.5 + this.field_70165_t, 0.5 + this.field_70163_u, 0.5 + this.field_70161_v, (double)f, (double)f2, (double)f3, new int[0]);
        }
    ...
    public void registerControllers(AnimationData animationData) {
        a = new AnimationController((IAnimatable)this, "controller", 5.0f, this::a);
    ...
    protected <E extends IAnimatable> PlayState a(AnimationEvent<E> animationEvent) {
        int n = (Integer)this.field_70180_af.func_187225_a(c);
        if (12000 - n < 20) {
            animationEvent.getController().setAnimation(new AnimationBuilder().addAnimation("animation.model.hatch", Boolean.valueOf(true)));
            return PlayState.CONTINUE;
        }
        float f = (float)n / 12000.0f;
        if ((double)f > 0.98) {
            animationEvent.getController().setAnimation(new AnimationBuilder().addAnimation("animation.model.veryfast", Boolean.valueOf(true)));
            return PlayState.CONTINUE;
        }
        if ((double)f > 0.85) {
            animationEvent.getController().setAnimation(new AnimationBuilder().addAnimation("animation.model.fast", Boolean.valueOf(true)));
            return PlayState.CONTINUE;
        }
        if ((double)f > 0.75) {
            animationEvent.getController().setAnimation(new AnimationBuilder().addAnimation("animation.model.medium", Boolean.valueOf(true)));
            return PlayState.CONTINUE;
        }
        if ((double)f > 0.5) {
            animationEvent.getController().setAnimation(new AnimationBuilder().addAnimation("animation.model.slow", Boolean.valueOf(true)));
            return PlayState.CONTINUE;
        }
        return PlayState.CONTINUE;
    }
