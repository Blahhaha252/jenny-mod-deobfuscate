 ...
 *  software.bernie.geckolib3.core.builder.Animation
...
public enum fp {
    ...
    private fp(int n2, boolean bl, boolean bl2) {
    ...
    private fp(int n2, boolean bl, boolean bl2, boolean bl3) {
        this(n2, bl, bl2);
        this.useBoyCam = bl3;
    }

    private fp(int n2, boolean bl, boolean bl2, boolean bl3, boolean bl4) {
        this(n2, bl, bl2);
        this.useBoyCam = bl3;
        this.hideNameTag = bl4;
    }

    private fp(int n2, boolean bl, boolean bl2, float f, float f2, boolean bl3) {
        this.transitionTick = n2;
        this.hasPlayer = bl;
        this.autoBlink = bl2;
        this.maxGirlPitch = f;
    ...
    private fp(int n2, boolean bl, boolean bl2, float f, float f2, boolean bl3, boolean bl4) {
        this.transitionTick = n2;
        this.hasPlayer = bl;
        this.autoBlink = bl2;
        this.maxGirlPitch = f;
    ...
    private fp(int n2, boolean bl, boolean bl2, boolean bl3, float f, float f2, boolean bl4) {
        this.transitionTick = n2;
        this.hasPlayer = bl;
        this.autoBlink = bl2;
        this.maxGirlPitch = f;
    ...
    private fp(int n2, boolean bl, boolean bl2, int n3, fp fp2) {
        this(n2, bl, bl2);
        this.length = n3;
        this.followUp = fp2;
    }

    private fp(int n2, boolean bl, boolean bl2, boolean bl3, int n3, fp fp2) {
        this(n2, bl, bl2);
        this.length = n3;
        this.followUp = fp2;
        this.useBoyCam = bl3;
    ...
    private fp(int n2, boolean bl, boolean bl2, boolean bl3, int n3, fp fp2, float f, float f2, boolean bl4) {
        this.transitionTick = n2;
        this.hasPlayer = bl;
        this.autoBlink = bl2;
        this.length = n3;
    ...
    private fp(int n2, boolean bl, boolean bl2, boolean bl3, boolean bl4, int n3, fp fp2) {
        this(n2, bl, bl2);
        this.length = n3;
        this.followUp = fp2;
        this.useBoyCam = bl4;
    ...
    @SideOnly(value=Side.CLIENT)
    public static float c(em em2, float f) {
        return (float)(em2.getFactory().getOrCreateAnimationData((Integer)Integer.valueOf((int)em2.func_110124_au().hashCode())).tick + (double)f - em2.C.tickOffset);
    }

    @SideOnly(value=Side.CLIENT)
    public static float a(em em2, float f) {
        return fp.c(em2, f) / 20.0f;
    }

    @SideOnly(value=Side.CLIENT)
    public static float d(em em2, float f) {
        float f2 = fp.a(em2);
        if (f2 <= 0.0f) {
            return 0.0f;
        }
        return be.b(fp.c(em2, f) / f2, 0.0f, 1.0f);
    }

    @SideOnly(value=Side.CLIENT)
    public static boolean b(em em2, float f) {
        return fp.d(em2, f) == 1.0f;
    }
