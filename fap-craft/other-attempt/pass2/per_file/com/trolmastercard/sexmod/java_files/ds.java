    ...
    public void a(RenderGameOverlayEvent renderGameOverlayEvent) {
        if (d && renderGameOverlayEvent.getType() == RenderGameOverlayEvent.ElementType.TEXT) {
            ...
            if (c >= 1.0) {
                ...
                n = i ? 54 : 0;
                this.func_73729_b(240, 160, 0, 108 + n, 256, 52);
            }
            if (h && !i) {
                n = d3.d ? 54 : 0;
                this.func_73729_b((int)b6.a(-200.0f, 98.0f, f), 405, 0, n, 158, 54);
            }
            ...
            n = (int)b6.b(0.0, 160.0, a);
            int n2 = (int)b6.b(167.0, 8.0, a);
            double d = b6.b(178.0, 18.0, a);
            if (!i) {
                this.func_73729_b(67, (int)b6.b(-45.0, d, (double)f), 159, n2, 32, n);
