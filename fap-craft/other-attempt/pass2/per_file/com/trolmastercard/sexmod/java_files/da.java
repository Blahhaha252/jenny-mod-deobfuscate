...
implements c3 {
    ...
    void d(f_ f_2) {
        ...
        boolean bl2 = bl = Math.abs(vec3d2.field_72450_a) + Math.abs(vec3d2.field_72449_c) < (double)0.05f;
        if (bl) {
            f_2.field_70761_aq = this.s;
            f_2.field_70760_ar = this.s;
        } else {
            float f;
            f_2.field_70761_aq = f = (float)(gc.b(Math.atan2(vec3d2.field_72449_c, vec3d2.field_72450_a)) - 90.0);
            f_2.field_70760_ar = f;
            this.s = f;
        }
    }
    ...
    public static Vec3d a(f_ f_2, float f) {
        ...
        Vec3d vec3d = b6.a(new Vec3d(entityLivingBase.field_70169_q, entityLivingBase.field_70167_r, entityLivingBase.field_70166_s), entityLivingBase.func_174791_d(), (double)f);
        ...
        block30: {
            switch (string) {
                ...
                case "head": {
                    ...
                    float f = i.func_184121_ak();
                    Vec3d vec3d = b6.a(new Vec3d(((f_)this.j).field_70142_S, ((f_)this.j).field_70137_T, ((f_)this.j).field_70136_U), ((f_)this.j).func_174791_d(), (double)f);
                    Vec3d vec3d2 = b6.a(new Vec3d(entityLivingBase.field_70142_S, entityLivingBase.field_70137_T, entityLivingBase.field_70136_U), ((f_)this.j).func_174791_d(), (double)f);
                    Vec3d vec3d3 = vec3d.func_178788_d(vec3d2);
                    float f5 = (float)ck.a((Vec3d)vec3d3, (float)((f_)this.j).field_70761_aq).field_72449_c;
                    float f6 = (float)Math.atan2(vec3d3.field_72448_b, f5);
                    break;
                }
                case "weapon": {
    ...
    void c(BufferBuilder bufferBuilder, GeoBone geoBone) {
        ...
        float f = ((f_)this.j).aD ? 1.0f - Math.min(0.29f, fp.a(this.j, i.func_184121_ak())) / 0.29f : 1.0f;
