...
public enum fy {
    ...
    private fy(Class<? extends em> clazz, int n2, Class<? extends ei> clazz2, int n3, boolean bl) {
        this.npcID = n2;
        this.playerID = n3;
        this.npcClass = clazz;
    ...
    private fy(Class<? extends em> clazz, int n2, Class<? extends ei> clazz2, int n3) {
        this.npcID = n2;
        this.playerID = n3;
        this.npcClass = clazz;
        this.playerClass = clazz2;
    ...
    private fy(Class<? extends em> clazz, int n2) {
        this.npcID = n2;
        this.npcClass = clazz;
        this.isNpcOnly = true;
        this.hasSpecifics = false;
    ...
    public static fy a(Entity entity) {
        ...
        em em2 = (em)entity;
        Class<?> clazz = ((Object)((Object)em2)).getClass();
        for (fy fy2 : fy.values()) {
