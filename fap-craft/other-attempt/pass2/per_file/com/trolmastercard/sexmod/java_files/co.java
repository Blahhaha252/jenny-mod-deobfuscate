...
extends Potion {
    ...
    public co(String string, boolean bl, int n, int n2, int n3) {
        super(bl, n);
        this.func_76390_b(string);
        this.func_76399_b(n2, n3);
    ...
    public void a(LivingEvent.LivingUpdateEvent livingUpdateEvent) {
        ...
        if (livingUpdateEvent.getEntity() instanceof EntityVillager && (entityVillager = (EntityVillager)livingUpdateEvent.getEntity()).func_70644_a(b)) {
