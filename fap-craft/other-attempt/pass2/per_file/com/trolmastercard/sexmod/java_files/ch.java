...
extends GuiScreen {
    ...
    public void func_73863_a(int n, int n2, float f) {
        ...
        this.field_146292_n.add(new GuiButton(0, n3 / 2 - 119 + (int)(100.0 - 100.0 * this.d), 30, (int)(this.d * 100.0), 20, this.e ? I18n.func_135052_a((String)"action.names.stopfollowme", (Object[])new Object[0]) : I18n.func_135052_a((String)"action.names.followme", (Object[])new Object[0])));
        this.field_146292_n.add(new GuiButton(1, n3 / 2 + 19, 30, (int)(this.d * 100.0), 20, I18n.func_135052_a((String)"action.names.gohome", (Object[])new Object[0])));
        this.field_146297_k.field_71446_o.func_110577_a(b);
        this.func_73729_b(n3 / 2 - 7, 61 - (int)(15.0 - this.d * 15.0), 32, 0, 15, 15);
        this.field_146292_n.add(new GuiButton(2, n3 / 2 - 10, 59 - (int)(15.0 - this.d * 15.0), 20, 20, ""));
        this.func_73729_b(n3 / 2 - 20, 20, (Boolean)this.c.func_184212_Q().func_187225_a(fo.K) != false ? 0 : 40, 130, 40, 40);
    }
