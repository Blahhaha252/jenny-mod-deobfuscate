...
implements IAnimatable {
    ...
    public void func_77663_a(ItemStack itemStack, World world, Entity entity, int n, boolean bl) {
        ...
        NBTTagCompound nBTTagCompound = entityPlayer.getEntityData();
        long l = nBTTagCompound.func_74763_f(b);
        long l2 = nBTTagCompound.func_74763_f(m);
...
lbl-1000:
        ...
        var9_8 = var8_7.func_178787_e(ck.a((float)(var1_1.func_184614_ca().func_77973_b().equals((Object)cc.r) != false ? 1 : -1) * 0.1f, (double)(-0.01f + var1_1.field_70125_A * 0.0015f), 0.0, var1_1.field_70761_aq));
    ...
    void a(EntityPlayer entityPlayer, long l, long l2) {
        ...
        Vec3d vec3d2 = vec3d.func_178787_e(ck.a((float)(entityPlayer.func_184614_ca().func_77973_b().equals((Object)r) ? 1 : -1) * 0.1f, (double)(-0.01f + entityPlayer.field_70125_A * 0.0015f), 0.0, entityPlayer.field_70761_aq));
        ...
        Vec3d vec3d4 = b6.a(vec3d2, vec3d3, (double)f);
        ez.b = 0.2f;
...
lbl-1000:
    ...
    void a(EntityPlayer entityPlayer, NBTTagCompound nBTTagCompound, long l, long l2) {
        ...
        if (!bl && l3 > 1000L - (long)(world.field_72995_K ? 0 : 150)) {
