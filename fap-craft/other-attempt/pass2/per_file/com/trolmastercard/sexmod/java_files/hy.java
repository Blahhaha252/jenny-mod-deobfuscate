...
implements IAnimatable {
    ...
    public static void a(ModelRegistryEvent modelRegistryEvent) {
        ...
        b.setTileEntityItemStackRenderer((TileEntityItemStackRenderer)new fa());
    }
    ...
    public static class a$a {
        ...
        public void a(PlayerInteractEvent.RightClickItem rightClickItem) {
            ...
            if (entityPlayer.func_184586_b(EnumHand.MAIN_HAND).func_77973_b() != b && entityPlayer.func_184586_b(EnumHand.OFF_HAND).func_77973_b() != b) {
                return;
            }
            if (ff.aY.isEmpty()) {
                return;
