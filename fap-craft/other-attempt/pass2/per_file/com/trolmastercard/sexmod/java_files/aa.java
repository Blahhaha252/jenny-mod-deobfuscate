...
extends EntityAINearestAttackableTarget<ff> {
    ...
    public aa(EntityCreature entityCreature, boolean bl, boolean bl2) {
        this(entityCreature, bl, false, bl2);
    }

    public aa(EntityCreature entityCreature, boolean bl, boolean bl2, boolean bl3) {
        this(entityCreature, 10, bl, bl2, null, bl3);
    }

    public aa(EntityCreature entityCreature, int n, boolean bl, boolean bl2, @Nullable Predicate predicate, boolean bl3) {
        super(entityCreature, ff.class, n, bl, bl2, predicate);
        this.a = n;
        this.b = bl3;
    }
    ...
    public boolean func_75250_a() {
        float f;
        if (this.b && (f = this.field_75299_d.func_70013_c()) >= 0.5f) {
            return false;
        }
