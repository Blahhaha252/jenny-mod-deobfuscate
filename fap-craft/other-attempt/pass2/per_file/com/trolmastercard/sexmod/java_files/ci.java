...
extends cv {
    ...
    public void a(em em2, Integer n, AnimationEvent animationEvent) {
        block10: {
            ...
            if (bl && fp2 == fp.AWAIT_PICK_UP || fp2 == fp.VANISH) {
    ...
    void a(AnimationProcessor animationProcessor, ai ai2, em em2) {
        ...
        float f = b6.a(entityPlayer.field_184618_aE, entityPlayer.field_70721_aZ, this.f.func_184121_ak());
    ...
    void a(em em2, IBone iBone) {
        ...
        float f = em2.field_70177_z;
        boolean bl = false;
        switch ((int)f) {
            case 0: {
                bl = vec3d.field_72449_c > vec3d2.field_72449_c;
                break;
            }
            case 180: {
                bl = vec3d.field_72449_c < vec3d2.field_72449_c;
            ...
            case 90: {
                bl = vec3d.field_72450_a < vec3d2.field_72450_a;
                break;
            }
            case -90: {
                boolean bl2 = bl = vec3d.field_72450_a > vec3d2.field_72450_a;
            }
        }
        if (!bl) {
        ...
        float f3 = (float)(-(MathHelper.func_181159_b((double)vec3d3.field_72449_c, (double)vec3d3.field_72450_a) * 57.29577951308232 + (double)f2));
        float f4 = be.b((float)((double)entityPlayer.func_70047_e() + vec3d.field_72448_b - ((double)em2.func_70047_e() + vec3d2.field_72448_b)), -0.75f, 0.75f);
        iBone.setRotationY(gc.c(f3));
        iBone.setRotationX(f4);
    }
    ...
    void a(em em2, IBone iBone, IBone iBone2) {
        ...
        Vec3d vec3d2 = em2.func_174791_d();
        Vec3d vec3d3 = vec3d.func_178788_d(vec3d2);
        float f = (float)(-(Math.atan2(vec3d3.field_72449_c, vec3d3.field_72450_a) * 57.29577951308232)) + 90.0f;
        float f2 = be.b((float)((double)entityPlayer.func_70047_e() + vec3d.field_72448_b - ((double)em2.func_70047_e() + vec3d2.field_72448_b)), -0.75f, 0.75f);
        iBone.setRotationY(gc.c(f));
