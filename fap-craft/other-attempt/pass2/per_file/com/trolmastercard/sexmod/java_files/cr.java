...
extends cv {
    ...
    public void a(em em2, Integer n, AnimationEvent animationEvent) {
        ...
        if (!(em2.field_70170_p instanceof gj) && animationProcessor.getBone("bedSlime") != null && animationProcessor.getBone("bedSlimeLayer") != null) {
            animationProcessor.getBone("bedSlime").setHidden(!Arrays.asList(this.f).contains((Object)em2.y()));
            animationProcessor.getBone("bedSlimeLayer").setHidden(!Arrays.asList(this.f).contains((Object)em2.y()));
        }
