...
extends ItemFishingRod {
    ...
    public gp() {
        ...
        this.func_77625_d(1);
        this.func_185043_a(new ResourceLocation("cast"), new IItemPropertyGetter(this){
            final /* synthetic */ gp this$0;
            {
                this.this$0 = gp2;
            }
            ...
            public float func_185085_a(ItemStack itemStack, @Nullable World world, @Nullable EntityLivingBase entityLivingBase) {
                ...
                return (Boolean)entityLivingBase.func_184212_Q().func_187225_a(eb.af) != false ? 1.0f : 0.0f;
            }
    ...
    public ActionResult<ItemStack> a(World world, eb eb2, EnumHand enumHand) {
        ...
        if (eb2.av != null) {
            int n = eb2.av.c();
            itemStack.func_77972_a(n, (EntityLivingBase)eb2);
            ...
            if (!world.field_72995_K) {
                int n;
                gi.b = eb2;
                double d = eb2.func_174791_d().func_72438_d(new Vec3d((double)eb2.ai.func_177958_n(), (double)eb2.ai.func_177956_o(), (double)eb2.ai.func_177952_p()));
                gi gi2 = new gi(world, eb2, d * eb.ap);
                int n2 = EnchantmentHelper.func_191528_c((ItemStack)itemStack);
                if (n2 > 0) {
                    gi2.b(n2);
                }
                if ((n = EnchantmentHelper.func_191529_b((ItemStack)itemStack)) > 0) {
                    gi2.a(n);
                }
