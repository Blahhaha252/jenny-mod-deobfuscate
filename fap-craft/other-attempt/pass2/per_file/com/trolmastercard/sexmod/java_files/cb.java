...
extends cv {
    ...
    void i(em em2) {
        ...
        float f = this.a.func_184121_ak() + (float)this.a.field_71439_g.field_70173_aa;
        f7 f72 = this.a((f_)em2, f);
        ...
        float f3 = (float)(Math.sin(f * 0.3f) * 10.0);
        if (f3 > 0.0f && this.g < 0.0f || f3 < 0.0f && this.g > 0.0f) {
    ...
    void e(em em2) {
        ...
        boolean bl = ((b7)((Object)em2)).c();
        boolean bl2 = fp.a(em2, fp.PUSSY_LICKING, fp.MASTERBATE_SITTING, fp.MASTERBATE_SITTING_CUM);
        if (iBone == null) {
            return;
        }
        if (iBone3 == null) {
    ...
    void b(em em2) {
        ...
        boolean bl2 = bl = Math.abs(vec3d2.field_72450_a) + Math.abs(vec3d2.field_72449_c) < (double)0.01f;
        if (bl) {
    ...
    void a(em em2) {
        ...
        float f3 = Minecraft.func_71410_x().func_184121_ak();
        IBone iBone = this.getAnimationProcessor().getBone("rotationTool");
        f2 f22 = ((b7)((Object)em2)).d();
        iBone.setRotationX((float)b6.b(f22.c + (double)f, f22.d + (double)f, (double)f3));
        iBone.setRotationZ((float)b6.b(f22.b, f22.a, (double)f3));
    }
