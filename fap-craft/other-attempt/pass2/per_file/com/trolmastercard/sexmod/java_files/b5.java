...
extends GuiScreen {
    ...
    protected void func_146284_a(GuiButton guiButton) {
        block3: {
            if (">".equals(guiButton.field_146126_j) && ++this.b >= this.a.size()) {
                this.b = 0;
            }
            if ("<".equals(guiButton.field_146126_j) && --this.b < 0) {
                this.b = this.a.size() - 1;
            }
            if (guiButton.field_146127_k != 0) break block3;
    ...
    public static void a(int n2, int n3, int n4, EntityLivingBase entityLivingBase) {
        ...
        float f7 = Minecraft.func_175610_ah();
        if (f7 == 0.0f) {
            f7 = 0.1f;
        }
        c += 60.0f / f7;
