...
implements LayerRenderer<ay> {
    ...
    public void a(ay ay2, float f, float f2, float f3, float f4, float f5, float f6, float f7) {
        block0: {
            if (ay2.func_82150_aj()) break block0;
            GlStateManager.func_179131_c((float)1.0f, (float)1.0f, (float)1.0f, (float)1.0f);
            GlStateManager.func_179108_z();
            GlStateManager.func_179147_l();
            GlStateManager.func_187401_a((GlStateManager.SourceFactor)GlStateManager.SourceFactor.SRC_ALPHA, (GlStateManager.DestFactor)GlStateManager.DestFactor.ONE_MINUS_SRC_ALPHA);
            this.a.func_178686_a(this.b.func_177087_b());
            this.a.func_78088_a((Entity)ay2, f, f2, f4, f5, f6, f7);
