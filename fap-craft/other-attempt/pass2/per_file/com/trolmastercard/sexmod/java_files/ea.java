...
extends GuiScreen {
    ...
    public void func_73863_a(int n, int n2, float f) {
        ...
        this.g += (float)(n < this.field_146294_l / 2 ? 1 : -1) * this.field_146297_k.func_193989_ak();
        this.e += (float)(n > this.field_146294_l / 2 ? 1 : -1) * this.field_146297_k.func_193989_ak();
        this.d += (float)(n2 < this.field_146295_m / 2 - 1 ? 1 : -1) * this.field_146297_k.func_193989_ak();
        this.m += (float)(n2 > this.field_146295_m / 2 ? 1 : -1) * this.field_146297_k.func_193989_ak();
        ...
        this.func_175174_a(-62.0f + f3 - this.g * 15.0f, f3 - 32.0f, 0, 0, 64, 64);
        this.func_175174_a(-62.0f + f3 - this.g * 15.0f, f3 - 32.0f, 64, 128, 64, 64);
        ...
        this.func_175174_a(-2.0f - f3 + this.e * 32.0f, -f3 - 32.0f, 0, 0, 64, 64);
        this.func_175174_a(-2.0f - f3 + this.e * 32.0f, -f3 - 32.0f, 0, 128, 64, 64);
        GlStateManager.func_179121_F();
        if (this.e > 0.0f) {
            GlStateManager.func_179094_E();
            GlStateManager.func_179152_a((float)(-1.0f + this.e + 1.0f + this.d * 0.5f), (float)(-1.0f + this.e + 1.0f + this.d * 0.5f), (float)1.0f);
            this.func_175174_a(-2.0f - f3 + this.d * 5.0f, -f3 - 64.0f - this.d * 5.0f / 2.0f, 0, 0, 64, 64);
            this.func_175174_a(-2.0f - f3 + this.d * 5.0f, -f3 - 64.0f - this.d * 5.0f / 2.0f, 128, 128, 64, 64);
            GlStateManager.func_179121_F();
            GlStateManager.func_179094_E();
            GlStateManager.func_179152_a((float)(-1.0f + this.e + 1.0f + this.m * 0.5f), (float)(-1.0f + this.e + 1.0f + this.m * 0.5f), (float)1.0f);
            this.func_175174_a(-2.0f - f3 + this.m * 5.0f, -f3 + this.m * 5.0f / 2.0f, 0, 0, 64, 64);
            this.func_175174_a(-2.0f - f3 + this.m * 5.0f, -f3 + this.m * 5.0f / 2.0f, 192, 128, 64, 64);
            GlStateManager.func_179121_F();
        }
        GlStateManager.func_179121_F();
        GL11.glDisable((int)3042);
