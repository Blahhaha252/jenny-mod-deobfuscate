...
extends EntityAIBase {
    ...
    public void func_75246_d() {
        block0: {
            float f10;
            float f11 = (float)((double)((float)this.b.func_177958_n() + 0.5f) - this.c.field_70165_t);
            float f12 = this.f * f11 + this.a * (f10 = (float)((double)((float)this.b.func_177952_p() + 0.5f) - this.c.field_70161_v));
            if (!(f12 < 0.0f) || --this.g > 0) break block0;
