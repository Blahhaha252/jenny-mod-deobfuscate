...
public enum h8 {
    CHANGE_POSITION(f_2 -> {
        ...
        int n2 = 0;
        boolean bl2 = !world.func_175623_d(blockPos.func_177977_b());
        for (int i2 = -10; i2 < 10; ++i2) {
            for (int i3 = -10; i3 < 10; ++i3) {
                for (int i4 = -10; i4 < 10; ++i4) {
                    RayTraceResult rayTraceResult;
                    if (i2 == 0 && i3 == 0 && i4 == 0) continue;
                    BlockPos blockPos3 = blockPos2.func_177971_a((Vec3i)new BlockPos(i2, i3, i4));
                    if (bl2 && blockPos.func_177956_o() >= blockPos3.func_177956_o() || !world.func_175623_d(blockPos3) || !world.func_175623_d(blockPos3.func_177984_a()) || !world.func_175623_d(blockPos3.func_177984_a().func_177984_a()) || (rayTraceResult = world.func_147447_a(new Vec3d((Vec3i)blockPos), new Vec3d((Vec3i)blockPos3), true, true, true)) != null) continue;
                    ...
                    for (int i5 = -1; i5 < 2; ++i5) {
                        for (int i6 = -1; i6 < 2; ++i6) {
                            for (int i7 = -1; i7 < 4; ++i7) {
                                if (!world.func_175623_d(blockPos3.func_177982_a(i5, i7, i6))) continue;
                                ++n4;
                            }
                        }
                    }
    ...
    SUMMON_SKELETON(f_2 -> {
        ...
        boolean bl2 = (Boolean)f_2.func_184212_Q().func_187225_a(f_.ay);
        if (((Boolean)f_2.func_184212_Q().func_187225_a(f_.bN)).booleanValue()) {
            vec3d3 = vec3d4.func_178787_e(ck.a(bl2 ? ck.c(f_.bz) : f_.bz, 180.0f + f_2.field_70761_aq));
        ...
        if (((Boolean)f_2.func_184212_Q().func_187225_a(f_.b7)).booleanValue()) {
            vec3d3 = vec3d4.func_178787_e(ck.a(bl2 ? ck.c(f_.bC) : f_.bC, 180.0f + f_2.field_70761_aq));
            vec3d2 = vec3d5.func_178788_d(vec3d3).func_72432_b();
            vec3d2 = new Vec3d(vec3d2.field_72450_a + random.nextDouble() * (double)0.3f, vec3d2.field_72448_b + random.nextDouble() * (double)0.3f, vec3d2.field_72449_c + random.nextDouble() * (double)0.3f);
            vec3d2 = vec3d2.func_72432_b();
            vec3d = new Vec3d(vec3d2.field_72450_a * (double)0.4f, vec3d2.field_72448_b * (double)0.4f, vec3d2.field_72449_c * (double)0.4f);
    ...
    RAPE(f_2 -> {
        ...
        block7: {
            ...
            for (EntityPlayer entityPlayer2 : list) {
                ...
                d11 = Math.abs(vec3d6.field_72450_a);
                if (d11 > (double)0.65f) continue;
            ...
            boolean bl3 = bl2 = vec3d3.func_72438_d(new Vec3d(vec3d8.field_72450_a, vec3d3.field_72448_b, vec3d8.field_72449_c)) > vec3d3.func_72438_d(new Vec3d(vec3d.field_72450_a, vec3d3.field_72448_b, vec3d.field_72449_c));
            if (bl2) {
                d11 = ck.a((Vec3d)entityPlayer2, vec3d, vec3d3);
                d10 = entityPlayer2.func_72438_d(vec3d);
            } else {
                d11 = ck.a(vec3d8, (Vec3d)entityPlayer2, vec3d3);
                d10 = vec3d8.func_72438_d((Vec3d)entityPlayer2);
            }
            double d12 = d10 / (double)0.05f;
            double d13 = 1.0 / d12 * 20.0;
            d11 += d13;
            if (!bl2 && d11 < (double)0.9f) {
                f_2.O = entityLivingBase.func_174791_d().func_72441_c(0.0, (double)(entityLivingBase.func_70047_e() / 2.0f), 0.0);
            }
            vec3d3 = bl2 ? new Vec3d(b6.b(entityPlayer2.field_72450_a, vec3d.field_72450_a, Math.min(1.0, d11)), b6.b(entityPlayer2.field_72448_b, vec3d.field_72448_b, Math.min(1.0, b6.a(d11))), b6.b(entityPlayer2.field_72449_c, vec3d.field_72449_c, Math.min(1.0, d11))) : new Vec3d(b6.b(vec3d8.field_72450_a, entityPlayer2.field_72450_a, d11), b6.b(vec3d8.field_72448_b, entityPlayer2.field_72448_b, b6.g(d11)), b6.b(vec3d8.field_72449_c, entityPlayer2.field_72449_c, d11));
            f_2.func_70107_b(vec3d3.field_72450_a, vec3d3.field_72448_b, vec3d3.field_72449_c);
            if (!bl2) break block7;
            f_2.func_184212_Q().func_187227_b(f_.bO, (Object)Float.valueOf((float)d11));
        }
    }, f_2 -> {
