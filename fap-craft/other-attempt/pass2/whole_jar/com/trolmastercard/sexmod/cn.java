...
public class cn {
    ...
    public void a(RenderSpecificHandEvent renderSpecificHandEvent) {
        ...
        try {
            ...
            if (ad.a()) {
                f10 = ((Float)ObfuscationReflectionHelper.getPrivateValue(ItemRenderer.class, (Object)itemRenderer, (String)"prevEquippedProgressMainHand")).floatValue();
                ...
                f10 = ((Float)ObfuscationReflectionHelper.getPrivateValue(ItemRenderer.class, (Object)itemRenderer, (String)"field_187470_g")).floatValue();
            ...
            this.g = 2.0f - (f10 + (f11 - f10) * renderSpecificHandEvent.getPartialTicks());
        }
        ...
        float f12 = itemRenderer.func_70678_g(renderSpecificHandEvent.getPartialTicks());
        ...
        if (renderSpecificHandEvent.getHand() == EnumHand.MAIN_HAND) {
            if (itemStack.func_190926_b() || itemStack.func_77973_b() instanceof ItemMap) {
                ...
                this.a(itemStack, renderSpecificHandEvent.getPartialTicks(), (AbstractClientPlayer)itemRenderer, this.g, f12);
                this.c = true;
            } else if (f11 < f10) {
                if (this.c) {
                    renderSpecificHandEvent.setCanceled(true);
            ...
            renderSpecificHandEvent.setCanceled(true);
            this.a(EnumHandSide.LEFT, this.g - 1.0f, f12, this.f.field_71439_g.func_184592_cb());
        }
    ...
    void a(EnumHandSide enumHandSide, float f10, float f11, ItemStack itemStack) {
        float f12 = enumHandSide == EnumHandSide.RIGHT ? 1.0f : -1.0f;
        ...
        float f13 = MathHelper.func_76129_c((float)f11);
        float f14 = MathHelper.func_76126_a((float)(f13 * (float)Math.PI));
        float f15 = -0.5f * f14;
        float f16 = 0.4f * MathHelper.func_76126_a((float)(f13 * ((float)Math.PI * 2)));
        float f17 = -0.3f * MathHelper.func_76126_a((float)(f11 * (float)Math.PI));
        GlStateManager.func_179109_b((float)(f12 * f15), (float)(f16 - 0.3f * f14), (float)f17);
        GlStateManager.func_179114_b((float)(f14 * -45.0f), (float)1.0f, (float)0.0f, (float)0.0f);
        GlStateManager.func_179114_b((float)(f12 * f14 * -30.0f), (float)0.0f, (float)1.0f, (float)0.0f);
        this.a(itemStack);
        GlStateManager.func_179121_F();
    }
    ...
    private void a(EnumHandSide enumHandSide) {
        GlStateManager.func_179094_E();
        float f10 = enumHandSide == EnumHandSide.RIGHT ? 1.0f : -1.0f;
        ...
        GlStateManager.func_179114_b((float)(f10 * -41.0f), (float)0.0f, (float)0.0f, (float)1.0f);
        GlStateManager.func_179109_b((float)(f10 * 0.3f), (float)-1.1f, (float)0.45f);
        if (enumHandSide == EnumHandSide.RIGHT) {
    ...
    private void a(float f10, float f11, EnumHandSide enumHandSide) {
        boolean bl2 = enumHandSide != EnumHandSide.LEFT;
        float f12 = bl2 ? 1.0f : -1.0f;
        float f13 = MathHelper.func_76129_c((float)f11);
        float f14 = -0.3f * MathHelper.func_76126_a((float)(f13 * (float)Math.PI));
        float f15 = 0.4f * MathHelper.func_76126_a((float)(f13 * ((float)Math.PI * 2)));
        float f16 = -0.4f * MathHelper.func_76126_a((float)(f11 * (float)Math.PI));
        GlStateManager.func_179109_b((float)(f12 * (f14 + 0.64000005f)), (float)(f15 + -0.6f + f10 * -0.6f), (float)(f16 + -0.71999997f));
        GlStateManager.func_179114_b((float)(f12 * 45.0f), (float)0.0f, (float)1.0f, (float)0.0f);
        float f17 = MathHelper.func_76126_a((float)(f11 * f11 * (float)Math.PI));
        float f18 = MathHelper.func_76126_a((float)(f13 * (float)Math.PI));
        GlStateManager.func_179114_b((float)(f12 * f18 * 70.0f), (float)0.0f, (float)1.0f, (float)0.0f);
        GlStateManager.func_179114_b((float)(f12 * f17 * -20.0f), (float)0.0f, (float)0.0f, (float)1.0f);
        GlStateManager.func_179109_b((float)(f12 * -1.0f), (float)3.6f, (float)3.5f);
        GlStateManager.func_179114_b((float)(f12 * 120.0f), (float)0.0f, (float)0.0f, (float)1.0f);
        GlStateManager.func_179114_b((float)200.0f, (float)1.0f, (float)0.0f, (float)0.0f);
        GlStateManager.func_179114_b((float)(f12 * -135.0f), (float)0.0f, (float)1.0f, (float)0.0f);
        GlStateManager.func_179109_b((float)(f12 * 5.6f), (float)0.0f, (float)0.0f);
        GlStateManager.func_179109_b((float)0.5f, (float)1.1f, (float)0.0f);
    }
