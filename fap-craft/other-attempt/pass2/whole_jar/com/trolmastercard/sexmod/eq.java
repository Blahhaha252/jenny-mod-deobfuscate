...
implements ai {
    ...
    public boolean a(fp fp2, EntityPlayer entityPlayer) {
        block4: {
            ...
            float f11 = entityPlayer.field_70177_z;
            float f12 = fp2 == fp.PICK_UP ? 180.0f : 0.0f;
            float f13 = entityPlayer2.field_70177_z - 90.0f + f12;
            float f14 = entityPlayer2.field_70177_z + 90.0f + f12;
            if (f11 < f13) {
                entityPlayer.field_70177_z = f13;
            }
            if (f11 > f14) {
                entityPlayer.field_70177_z = f14;
            }
            float f15 = entityPlayer.field_70125_A;
            float f16 = f10 = fp2 == fp.PICK_UP ? 0.0f : 37.5f;
            if (!(f15 > f10)) break block4;
            entityPlayer.field_70125_A = f10;
        }
        return true;
    }
