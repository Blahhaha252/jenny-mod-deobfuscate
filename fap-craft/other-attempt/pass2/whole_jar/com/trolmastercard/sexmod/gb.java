...
extends Gui {
    ...
    public void a(RenderGameOverlayEvent renderGameOverlayEvent) {
        ...
        double d10 = c ? 1.0 - b6.d((d + f10) / 20.0f) : Math.min(1.0, b6.c((j + f10) / 20.0f));
        int n4 = n3 + 385;
        ...
        int n5 = 4 * n3;
        this.func_73729_b(n2 / 2 - 87, (int)b6.b((double)n5, (double)n4, d10), 0, 104, 174, 48);
        this.func_73729_b((int)((float)n2 / 2.0f - 78.0f), (int)b6.b((double)n5, (double)(n4 - 52), d10), 52, b && q == gr.A ? 52 : 0, 52, 52);
        this.func_73729_b((int)((float)n2 / 2.0f - 26.0f), (int)b6.b((double)n5, (double)(n4 - 52), d10), 104, b && q == gr.S ? 52 : 0, 52, 52);
        this.func_73729_b((int)((float)n2 / 2.0f + 26.0f), (int)b6.b((double)n5, (double)(n4 - 52), d10), 156, b && q == gr.D ? 52 : 0, 52, 52);
        this.func_73729_b((int)((float)n2 / 2.0f - 26.0f), (int)b6.b((double)n5, (double)(n4 - 104), d10), 0, b && q == gr.W ? 52 : 0, 52, 52);
        this.func_73729_b(n2 / 2 - 87 + 8, (int)b6.b((double)(n5 - 8), (double)(n4 + 8), d10), 8, 152, (int)(158.0f * k), 32);
