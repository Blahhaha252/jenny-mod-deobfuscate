...
extends GeoLayerRenderer {
    ...
    public void render(EntityLivingBase entityLivingBase, float f10, float f11, float f12, float f13, float f14, float f15, Color color) {
        ...
        float f16 = this.a();
        this.a.func_78087_a(f10, f11, f13, f14, f15, f16, (Entity)(entityPlayer == null ? entityLivingBase : entityPlayer));
        this.a.func_78088_a((Entity)(entityPlayer == null ? entityLivingBase : entityPlayer), f10, f11, f13, f14, f15, f16);
