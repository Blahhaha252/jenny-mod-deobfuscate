...
extends Entity {
    ...
    public void func_184206_a(DataParameter<?> dataParameter) {
        if (g.equals(dataParameter)) {
            ...
            this.i = n2 > 0 ? this.field_70170_p.func_73045_a(n2 - 1) : null;
        }
        ...
        if (this.b() == null) {
            ...
            if (this.n == a.a.FLYING) {
                ...
                if (this.n == a.a.BOBBING) {
                    ...
                    if (!this.field_70170_p.field_72995_K && f10 > 0.0f) {
                        this.a(blockPos);
                    }
                }
            }
    ...
    private void e() {
        ...
        for (Entity entity2 : list) {
            ...
            if (!this.a(entity2) || entity2 == this.b() && this.h < 5 || (rayTraceResult2 = (axisAlignedBB = entity2.func_174813_aQ().func_186662_g((double)0.3f)).func_72327_a(vec3d, vec3d2)) == null || !((d11 = vec3d.func_72436_e(rayTraceResult2.field_72307_f)) < d10) && d10 != 0.0) continue;
            entity = entity2;
            d10 = d11;
        }
        if (entity != null) {
    ...
    private void a(BlockPos blockPos) {
        ...
        if (this.d > 0) {
            ...
            if (this.j > 0) {
                ...
                float f10 = this.e * ((float)Math.PI / 180);
                float f11 = MathHelper.func_76126_a((float)f10);
                float f12 = MathHelper.func_76134_b((float)f10);
                double d11 = this.field_70165_t + (double)(f11 * (float)this.j * 0.1f);
                double d12 = (float)MathHelper.func_76128_c((double)this.func_174813_aQ().field_72338_b) + 1.0f;
                IBlockState iBlockState = worldServer.func_180495_p(new BlockPos(d11, d12 - 1.0, d10 = this.field_70161_v + (double)(f12 * (float)this.j * 0.1f)));
                if (iBlockState.func_185904_a() == Material.field_151586_h) {
                    if (this.field_70146_Z.nextFloat() < 0.15f) {
                        worldServer.func_175739_a(EnumParticleTypes.WATER_BUBBLE, d11, d12 - (double)0.1f, d10, 1, (double)f11, 0.1, (double)f12, 0.0, new int[0]);
                    }
                    float f13 = f11 * 0.04f;
                    float f14 = f12 * 0.04f;
                    worldServer.func_175739_a(EnumParticleTypes.WATER_WAKE, d11, d12, d10, 0, (double)f14, 0.01, (double)(-f13), 1.0, new int[0]);
                    worldServer.func_175739_a(EnumParticleTypes.WATER_WAKE, d11, d12, d10, 0, (double)(-f14), 0.01, (double)f13, 1.0, new int[0]);
                }
            } else {
            ...
            if (this.field_70146_Z.nextFloat() < f15) {
                ...
                double d16 = this.field_70165_t + (double)(MathHelper.func_76126_a((float)f16) * f17 * 0.1f);
                IBlockState iBlockState = worldServer.func_180495_p(new BlockPos((int)d16, (int)(d15 = (double)((float)MathHelper.func_76128_c((double)this.func_174813_aQ().field_72338_b) + 1.0f)) - 1, (int)(d14 = this.field_70161_v + (double)(MathHelper.func_76134_b((float)f16) * f17 * 0.1f))));
                if (iBlockState.func_185904_a() == Material.field_151586_h) {
                    worldServer.func_175739_a(EnumParticleTypes.WATER_SPLASH, d16, d15, d14, 2 + this.field_70146_Z.nextInt(2), (double)0.1f, 0.0, (double)0.1f, 0.0, new int[0]);
                }
            }
            if (this.c <= 0) {
    ...
    public int c() {
        if (!this.field_70170_p.field_72995_K && this.b() != null) {
            ...
            if (this.i != null) {
                ...
                n2 = this.i instanceof EntityItem ? 3 : 5;
            } else if (this.d > 0) {
            ...
            return var2_2 == null ? n2 : var2_2.getRodDamage();
        }
        return 0;
    }
