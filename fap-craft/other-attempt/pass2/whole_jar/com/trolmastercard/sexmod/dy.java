...
extends d6<e3> {
    ...
    @Override
    public void a(e3 e32, double d10, double d11, double d12, float f10, float f11) {
        block23: {
            Vec3d vec3d;
            this.j = e32;
            this.u = -420.69f == f10 && e32.y() == fp.SHOULDER_IDLE;
            this.F = -420.69f == f10 && e32.y() == fp.PICK_UP;
            ...
            UUID uUID = e32.e();
            if (e32.h()) {
                vec3d = dy.a(e32.field_70170_p, e32, uUID, d10, d11, d12);
                d10 = vec3d.field_72450_a;
                d11 = vec3d.field_72448_b;
                d12 = vec3d.field_72449_c;
            }
            if (fp2 == fp.THROWN || fp2 == fp.START_THROWING) {
                if (dy.y.field_71474_y.field_74320_O == 0 && f10 == -420.69f && !e32.h()) {
                    return;
                }
                if (!e32.h()) {
                    float f12;
                    e32.field_70760_ar = f12 = e32.I().floatValue();
                    e32.field_70761_aq = f12;
                }
            }
            if (dy.a((em)e32, fp2)) {
            ...
            super.a(e32, d10, d11, d12, f10, f11);
