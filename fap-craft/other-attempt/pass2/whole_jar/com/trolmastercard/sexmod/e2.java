    ...
    public void func_70619_bc() {
        ...
        if (this.field_70173_aa % 80 == 0 && this.func_110143_aJ() != this.func_110138_aP()) {
            if (!this.J()) {
                ...
                int n2 = list.isEmpty() ? 4 : 1;
                this.func_70691_i(n2);
                ((WorldServer)this.field_70170_p).func_180505_a(EnumParticleTypes.HEART, false, this.field_70165_t, this.field_70163_u + 1.0 + com.trolmastercard.sexmod.r.f.nextDouble(), this.field_70161_v, n2, 1.0, 1.0, 1.0, com.trolmastercard.sexmod.r.f.nextGaussian(), new int[0]);
            }
        }
        if (this.N && !this.J()) {
            this.N = false;
