...
extends em {
    ...
    public f_ a(boolean bl2) {
        ...
        em em3 = em2 = bl2 ? em.a(uUID) : em.b(uUID);
    ...
    void a(int n2) {
        ...
        this.a(n2 == -1 ? -1L : this.field_70170_p.func_82737_E());
    }
    ...
    public static boolean a(Entity entity, f_ f_2) {
        ...
        Float f10 = f_.a(f_2, 0.0f);
        float f11 = f10 == null ? f_2.field_70759_as : f10.floatValue();
        Vec3d vec3d2 = ck.a(vec3d, f11);
    ...
    void m() {
        ...
        float f10 = (float)(gc.b(Math.atan2(vec3d3.field_72449_c, vec3d3.field_72450_a)) + 90.0);
        Float f11 = f_.a(f_2, 0.0f);
        f10 -= f_2.field_70759_as;
        if (f11 != null) {
            f10 -= f11.floatValue();
        }
        this.af = Math.abs(cj.a(0.0f, f10)) < 80.0f ? -gc.c(f10) : 0.0f;
    ...
    Entity o() {
        ...
        for (EntityPlayer entityPlayer : this.field_70170_p.field_73010_i) {
            ...
            if (f10 > 6.0f || entity != null && !(entity.func_70032_d((Entity)this) > f10)) continue;
            entity = entityPlayer;
        }
        return entity;
    }
    ...
    protected boolean a(fp fp2, String string, boolean bl2, AnimationEvent animationEvent) {
        ...
        if ((this.N || bl2) && fp2 == fp.THREESOME_SLOW) {
            this.Y = false;
