...
extends GuiScreen {
    ...
    public void func_73863_a(int n2, int n3, float f10) {
        block3: {
            ...
            int n10 = 52;
            int n11 = 68;
            for (int i2 = 5; i2 < this.h.length + 5; ++i2) {
                if (this.n > 0.0f && this.f != null && this.f[i2 - 5] != null && this.f[i2 - 5].func_190916_E() != 0) {
                    this.field_73735_i = -300.0f;
                    this.field_146296_j.field_77023_b = -300.0f;
                    this.a(Arrays.asList(this.f[i2 - 5].func_190916_E() + "x    "), n4 - n6, n5 - n10, this.field_146289_q);
                    this.field_146296_j.func_175042_a(this.f[i2 - 5], n4 - n7, n5 - n11);
                    this.field_73735_i = 0.0f;
                    this.field_146296_j.field_77023_b = 0.0f;
                }
                this.field_146292_n.add(new GuiButton(i2, n4 - n8, n5 - n9, 100, 20, I18n.func_135052_a((String)this.h[i2 - 5], (Object[])new Object[0])));
                n9 += 30;
                n10 += 30;
                n11 += 30;
            }
    ...
    void a(int n2, int n3) {
        ...
        boolean bl2 = !((String)this.l.func_187225_a(em.v)).equals("");
        int n5 = 35;
        int n6 = 70;
        for (int i2 = 0; i2 < 5; ++i2) {
            ...
            this.d[i2] = n2 >= n5 && n2 <= n5 + 23 + this.d[i2] && n3 >= n6 && n3 <= n6 + 20 ? Math.min(this.e[i2], this.d[i2] + 7) : Math.max(0, this.d[i2] - 7);
            StringBuilder stringBuilder = new StringBuilder(I18n.func_135052_a((String)this.a[i2], (Object[])new Object[0]));
            for (int i3 = 0; i3 < this.b[i2]; ++i3) {
                stringBuilder.append(" ");
            }
            this.field_146297_k.field_71446_o.func_110577_a(c);
            this.func_73729_b(this.d[i2] + n5 - 18 + (int)b6.a(0.0f, 23.0f, this.n), n6 + 2, this.j[i2], 0, 16, 16);
            this.field_146292_n.add(new GuiButton(i2, n5 + 1, n6, (int)(b6.a(0.0f, 23.0f, this.n) + (float)this.d[i2]), 20, this.d[i2] <= 14 ? "" : stringBuilder.toString()));
            n6 += 30;
        }
        this.field_146297_k.field_71446_o.func_110577_a(c);
