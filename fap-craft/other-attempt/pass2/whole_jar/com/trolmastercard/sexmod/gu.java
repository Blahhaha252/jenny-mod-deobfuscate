    ...
    public void a(LivingDamageEvent livingDamageEvent) {
        ...
        if (!damageSource2.func_76363_c()) {
            for (ItemArmor itemArmor : arrayList) {
                n2 += a.a.a(itemArmor.field_77881_a, itemArmor.func_82812_d());
                n3 += a.a.b(itemArmor.field_77881_a, itemArmor.func_82812_d());
            }
        }
        float f10 = livingDamageEvent.getAmount();
        ...
        while (entityDamageSource.hasNext()) {
            ...
            f11 += r.f.nextFloat() < 0.15f * (float)n6 ? r.f.nextFloat() * 4.0f + 1.0f : 0.0f;
        ...
        if (f11 > 0.0f && damageSource2 instanceof EntityDamageSource && (entityDamageSource = (EntityDamageSource)damageSource2).func_76346_g() != null) {
