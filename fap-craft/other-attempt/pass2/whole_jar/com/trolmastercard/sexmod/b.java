...
extends GeoEntityRenderer<cy> {
    ...
    void a(br.b.b b10, cy cy2, float f10) {
        if (b10 == null || b10.i() == c8.DEFAULT) {
            this.j = null;
            return;
        }
        GL11.glDisable((int)2896);
        this.j = b10.i() == c8.SEXMOD ? cj.a(cy2, f10) : null;
    }
    ...
    public void a(cy cy2, double d10, double d11, double d12, float f10, float f11) {
        ...
        br.b.b b10 = br.b(cy2.a());
        this.c = cy2;
        this.b = b10;
        this.a(b10, cy2, f11);
        if (f11 == 1.876945f || f11 == 2.876945f) {
