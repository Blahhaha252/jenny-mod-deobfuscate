...
extends Gui {
    ...
    public void a(RenderGameOverlayEvent renderGameOverlayEvent) {
        ...
        float f10 = l2 < u + 500L ? (float)(l2 - u) / 500.0f : (l2 < g + 500L ? 1.0f + (float)(g - l2) / 500.0f : 1.0f);
        f10 = be.b(f10, 0.0f, 1.0f);
        GlStateManager.func_179131_c((float)1.0f, (float)1.0f, (float)1.0f, (float)f10);
        this.a(i, n4 - hf.i.c / 2, n3 - 70);
        this.a(p, (int)((float)n4 - 1.5f * (float)hf.w.c + 1.0f), n3 - 70 + 3);
        this.a(p, n4 - hf.w.c / 2 + 1, n3 - 70 + 3);
        this.a(p, n4 + hf.w.c / 2 + 1, n3 - 70 + 3);
        float f11 = (float)b6.b(Math.min(1.0f, (float)(l2 - s) / 150.0f));
        float f12 = f11 == 1.0f ? be.b(1.0f - (float)(l2 - f) / 500.0f, 0.0f, 1.0f) : 0.0f;
        this.a(1, -1.5f * (float)hf.w.c, f12, f11, n4, n3, f10);
        this.a(2, (float)(-hf.w.c) / 2.0f, f12, f11, n4, n3, f10);
        this.a(3, (float)hf.w.c / 2.0f, f12, f11, n4, n3, f10);
    }
