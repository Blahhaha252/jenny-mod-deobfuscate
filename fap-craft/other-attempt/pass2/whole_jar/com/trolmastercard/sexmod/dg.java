...
extends d9 {
    ...
    public void a(em em2, double d10, double d11, double d12, float f10, float f11) {
        block24: {
            ...
            this.D = v;
            this.B = (eq)em2;
            this.C = -420.69f == f10 && em2.y() == fp.SHOULDER_IDLE;
            this.E = -420.69f == f10 && em2.y() == fp.PICK_UP;
            this.y = f11;
            dy.B = f10;
            fp fp2 = em2.y();
            UUID uUID = this.B.e();
            if (em2.h()) {
                vec3d = dy.a(em2.field_70170_p, em2, uUID, d10, d11, d12);
                d10 = vec3d.field_72450_a;
                d11 = vec3d.field_72448_b;
                d12 = vec3d.field_72449_c;
            }
            if (fp2 == fp.THROWN || fp2 == fp.START_THROWING) {
                if (dg.i.field_71474_y.field_74320_O == 0 && f10 == -420.69f && !em2.h()) {
                    return;
                }
                if (!em2.h()) {
                    float f12;
                    em2.field_70760_ar = f12 = em2.I().floatValue();
                    em2.field_70761_aq = f12;
                }
            }
            if (dy.a(em2, fp2)) {
                ...
                Vector4f vector4f = dy.a((EntityPlayer)vec3d, f11);
                d10 = vector4f.x;
                d11 = vector4f.y;
                d12 = vector4f.z;
    ...
    protected f7 e(em em2) {
        ...
        int n2 = itemArmor.func_82814_b(itemStack);
        float f10 = n2 >> 16 & 0xFF;
        float f11 = n2 >> 8 & 0xFF;
        float f12 = n2 & 0xFF;
        return new f7(f10, f11, f12);
    }
    ...
    protected void a(boolean bl2, ItemStack itemStack) {
        ...
        GlStateManager.func_179114_b((float)(bl2 ? 70.0f : 180.0f), (float)1.0f, (float)0.0f, (float)0.0f);
