...
extends ei {
    ...
    protected <E extends IAnimatable> PlayState a(AnimationEvent<E> animationEvent) {
        ...
        block5 : switch (animationEvent.getController().getName()) {
            ...
            case "movement": {
                double d10 = 4.0 * (Math.abs(this.field_70165_t - this.field_70142_S) + Math.abs(this.field_70163_u - this.field_70137_T) + Math.abs(this.field_70161_v - this.field_70136_U));
                d10 = Math.min(1.0 + d10, 4.0);
                this.E.setAnimationSpeed(d10);
