...
extends Render<gi> {
    ...
    public void a(gi gi2, double d10, double d11, double d12, float f10, float f11) {
        ...
        int n2 = eb2.func_184591_cq() == EnumHandSide.RIGHT ? 1 : -1;
        ...
        double d13 = MathHelper.func_76126_a((float)f13);
        double d14 = MathHelper.func_76134_b((float)f13);
        double d15 = (double)n2 * 0.35;
        double d16 = eb2.field_70169_q + (eb2.field_70165_t - eb2.field_70169_q) * (double)f11 - d14 * d15 - d13 * 0.8;
        double d17 = eb2.field_70167_r + (double)eb2.func_70047_e() + (eb2.field_70163_u - eb2.field_70167_r) * (double)f11 - 0.45;
        double d18 = eb2.field_70166_s + (eb2.field_70161_v - eb2.field_70166_s) * (double)f11 - d13 * d15 + d14 * 0.8;
        double d19 = eb2.func_70093_af() ? -0.1875 : 0.0;
        double d20 = gi2.field_70169_q + (gi2.field_70165_t - gi2.field_70169_q) * (double)f11 - Math.sin((double)(eb2.I().floatValue() + 90.0f) * (Math.PI / 180)) * 0.1896224320030116 - Math.sin((double)eb2.I().floatValue() * (Math.PI / 180)) * 0.08742380916962415;
        double d21 = gi2.field_70167_r + (gi2.field_70163_u - gi2.field_70167_r) * (double)f11 + 0.25 + -0.5;
        double d22 = gi2.field_70166_s + (gi2.field_70161_v - gi2.field_70166_s) * (double)f11 + Math.cos((double)(eb2.I().floatValue() + 90.0f) * (Math.PI / 180)) * 0.1896224320030116 + Math.cos((double)eb2.I().floatValue() * (Math.PI / 180)) * 0.08742380916962415;
        double d23 = (float)(d16 - d20);
        double d24 = (double)((float)(d17 - d21)) + d19;
        double d25 = (float)(d18 - d22);
        ...
        if (itemStack.func_77973_b().equals(Items.field_190931_a)) {
            ...
            for (int i2 = 0; i2 <= 16; ++i2) {
                ...
                bufferBuilder.func_181662_b(d10 + d23 * (double)f14, d11 + d24 * (double)(f14 * f14 + f14) * 0.5 + 0.25, d12 + d25 * (double)f14).func_181669_b(0, 0, 0, 255).func_181675_d();
            }
            tessellator.func_78381_a();
        }
