...
extends cv {
    ...
    void d(em em2) {
        ...
        Entity entity = f82.b();
        boolean bl3 = bl2 = entity == null;
        if (!bl2) {
            f82.R = this.a(entity);
        }
        if ((f10 = (float)Minecraft.func_175610_ah()) == 0.0f) {
            f10 = 1.0f;
        }
        f82.V = f82.aj == bl2 ? 0.0f : (f82.V += 1.5f / f10);
        if (f82.V >= 1.0f) {
            f82.V = 0.0f;
            f82.aj = bl2;
        }
        a.a a10 = f82.V == 0.0f ? (bl2 ? this.a(f_2, iBone2, iBone, iBone3, iBone4) : this.a(f82, f_2, iBone4, iBone3, animationProcessor)) : a.a.a(this.a(f_2, iBone2, iBone, iBone3, iBone4), this.a(f82, f_2, iBone4, iBone3, animationProcessor), (float)(f82.aj ? b6.c(f82.V) : 1.0 - b6.c(f82.V)));
        iBone2.setRotationX(((a.a)a10).c.a);
        iBone2.setRotationY(((a.a)a10).c.c);
        iBone2.setRotationZ(((a.a)a10).c.b);
        iBone.setRotationX(((a.a)a10).g.a);
        iBone.setRotationY(((a.a)a10).g.c);
        iBone.setRotationZ(((a.a)a10).g.b);
        iBone3.setRotationX(((a.a)a10).b.a);
        iBone3.setRotationY(((a.a)a10).b.c);
        iBone3.setRotationZ(((a.a)a10).b.b);
        iBone4.setRotationX(((a.a)a10).h.a);
        iBone4.setRotationY(((a.a)a10).h.c);
        iBone4.setRotationZ(((a.a)a10).h.b);
        iBone.setScaleY(a10.a);
        iBone2.setScaleY(a10.f);
        iBone5.setRotationY(a10.d);
        iBone6.setRotationY(a10.e);
    }

    a.a a(@Nonnull f8 f82, @Nonnull f_ f_2, IBone iBone, IBone iBone2, AnimationProcessor animationProcessor) {
        float f10;
        a.a a10 = new a.a(null);
        a10.b = new f7(ce.m, 0.0f, iBone.getRotationZ());
        a10.h = new f7(ce.l, 0.0f, iBone2.getRotationZ());
        float f11 = f_2.aE + animationProcessor.getBone("upperBody").getRotationX();
        float f12 = this.a.func_184121_ak();
        Vec3d vec3d = dh.a(f_2, f12);
        ...
        Float f13 = f_.a(f_2, f12);
        float f14 = f13 == null ? b6.b(f_2.field_70758_at, f_2.field_70759_as, (double)f12) : f13.floatValue();
        float f15 = gc.c(f14);
        float f16 = f82.b(f12);
        float f17 = (float)b6.e(Math.min(1.0f, f16));
        if (f17 != 1.0f) {
            f10 = 0.0f;
        } else {
            f10 = (f16 * 28.0f - 28.0f) / 32.0f;
            f10 = Math.max(0.0f, f10 - 0.5f) * 2.0f;
        }
        float f18 = (float)b6.h(f10);
        float f19 = gc.c(b6.a(0.0f, 90.0f, f17));
        boolean bl2 = f82.a(f82.R, f12);
        if (bl2) {
            a10.c = new f7(-f11 + bm2.a + gc.c(90.0f), bm2.c, 0.0f);
            a10.g = new f7(-f11 + bm3.a + gc.c(90.0f), (float)((double)bm3.c + (double)gc.c(-20.0f) * Math.cos(bm2.c + f15 * 1.0f) + (double)b6.a(f19 / 2.0f, 0.0f, f18)), 0.0f);
            a10.a = 1.0f + Math.abs(Math.abs(bm2.c) - Math.abs(f15)) * 0.1909f;
            a10.e = gc.c(90.0f);
            ((a.a)a10).b.b = b6.a(f19, 0.0f, f18);
            if ((double)f10 > 0.5) {
                ((a.a)a10).b.a = m + (float)b6.b((double)g, 0.0, b6.h((f10 - 0.5f) * 2.0f));
            } else if (f10 != 0.0f && (double)f10 < 0.5) {
                ((a.a)a10).b.a = m + (float)b6.b(0.0, (double)g, b6.h(f10 * 2.0f));
            }
        } else {
            a10.g = new f7(-f11 + bm3.a + gc.c(90.0f), bm3.c, 0.0f);
            a10.c = new f7(-f11 + bm2.a + gc.c(90.0f), (float)((double)bm2.c + (double)gc.c(20.0f) * Math.cos(bm3.c + f15 * 1.0f)) - b6.a(f19 / 2.0f, 0.0f, f18), 0.0f);
            a10.f = 1.0f + Math.abs(Math.abs(bm3.c) - Math.abs(f15)) * 0.1909f;
            a10.d = gc.c(90.0f);
            ((a.a)a10).h.b = -b6.a(f19, 0.0f, f18);
            if ((double)f10 > 0.5) {
                ((a.a)a10).h.a = l + (float)b6.b((double)g, 0.0, b6.h((f10 - 0.5f) * 2.0f));
            } else if (f10 != 0.0f && (double)f10 < 0.5) {
                ((a.a)a10).h.a = l + (float)b6.b(0.0, (double)g, b6.h(f10 * 2.0f));
            }
        }
        ((a.a)a10).c.c += f15;
        ((a.a)a10).g.c += f15;
    ...
    void b(em em2) {
        ...
        AnimationProcessor animationProcessor = this.getAnimationProcessor();
        float f10 = f_2.aE;
        animationProcessor.getBone("rotationTool").setRotationX(f10);
        ...
        if (f10 > 0.0f) {
            iBone2.setRotationX(-1.1111112f * f10);
            iBone.setRotationX(0.1333f * f10);
            iBone3.setRotationX(f10 * 22.5f / 45.0f);
        } else {
            iBone2.setRotationX(-1.6666666f * f10);
            iBone.setRotationX(f10 * 0.666f);
        }
        float f11 = be.a((double)f82.T, f82.af);
        float f12 = be.a((double)f82.ai, f82.W);
        float f13 = Minecraft.func_175610_ah();
        if (f13 == 0.0f) {
            f13 = 1.0f;
        }
        float f14 = 7.0f * (Math.abs(f11) < 7.0f ? f11 : (f11 > 0.0f ? 7.0f : -7.0f)) * (1.0f / f13);
        float f15 = 7.0f * (Math.abs(f12) < 7.0f ? f12 : (f12 > 0.0f ? 7.0f : -7.0f)) * (1.0f / f13);
        float f16 = f82.T + f14;
        float f17 = f82.ai + f15;
        iBone.setRotationY(iBone.getRotationY() + f16);
        iBone.setRotationX(iBone.getRotationX() + f17);
        f82.T = f16;
        f82.ai = f17;
    }
    ...
    static void b(em em2, AnimationProcessor animationProcessor, float f10) {
        ...
        for (int i2 = 0; i2 < 3; ++i2) {
            IBone iBone = animationProcessor.getBone("cockStage" + i2);
            if (iBone == null) continue;
            iBone.setHidden(i2 > ((f8)em2).an);
        }
    }

    static void f(AnimationProcessor animationProcessor, boolean bl2) {
        animationProcessor.getBone("skirt").setHidden(!bl2);
    }
    ...
    static void e(AnimationProcessor animationProcessor, boolean bl2) {
        ...
        animationProcessor.getBone("sideRSkirt").setHidden(!bl2);
        animationProcessor.getBone("sideLNoSkirt").setHidden(bl2);
        animationProcessor.getBone("sideLSkirt").setHidden(!bl2);
    }
