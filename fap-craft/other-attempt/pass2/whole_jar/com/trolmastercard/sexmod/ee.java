        ...
        AnimationController.ISoundListener iSoundListener = soundKeyframeEvent -> {
            switch (soundKeyframeEvent.sound) {
                case "dashMSG1": {
                    ...
                    this.field_70177_z = f10 = (float)Math.atan2(vec3d.field_72449_c, vec3d.field_72450_a) * 57.29578f;
                ...
                case "dashDone": {
                    ...
                    EntityPlayer entityPlayer = this.field_70170_p.func_72890_a((Entity)this, 15.0);
                    if (entityPlayer == null) break;
                    this.field_70177_z = f11 = entityPlayer.field_70177_z;
                    this.field_70759_as = f11;
                    this.field_70761_aq = f11;
                    break;
                }
                case "hugMSG1": {
