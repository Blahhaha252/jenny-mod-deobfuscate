...
lbl-1000:
    ...
    void n() {
        ...
        if (this.R == null || this.func_70011_f(this.R.func_177958_n(), this.R.func_177956_o(), this.R.func_177952_p()) > this.l() || this.Y > 100) {
            ...
            this.R = new BlockPos(this.func_180425_c().func_177958_n() + n2, n4, this.func_180425_c().func_177952_p() + n3);
            this.Y = 0;
        }
    ...
    void J() {
        ...
        do {
            ...
            double d11 = vec3d2.field_72450_a / (vec3d2.field_72450_a + vec3d2.field_72449_c);
            double d12 = vec3d2.field_72449_c / (vec3d2.field_72450_a + vec3d2.field_72449_c);
            Vec3d vec3d3 = this.func_174791_d().func_178787_e(new Vec3d((double)(vec3d.field_72450_a > 0.0 ? 1 : -1) * d11 * d10, 0.0, (double)(vec3d.field_72449_c > 0.0 ? 1 : -1) * d12 * d10));
            PathNavigate pathNavigate = this.func_70661_as();
            pathNavigate.func_75499_g();
            bl2 = pathNavigate.func_75492_a(vec3d3.field_72450_a, vec3d3.field_72448_b, vec3d3.field_72449_c, (double)0.825f);
            d10 -= 1.0;
        } while (!bl2);
    }
