...
extends d_ {
    ...
    public void renderRecursively(BufferBuilder bufferBuilder, GeoBone geoBone, float f10, float f11, float f12, float f13) {
        ...
        if (string.equals("head")) {
            this.a(bufferBuilder, geoBone, Color.ofRGB(f10, f11, f12));
        }
        ...
        if (!geoBone.isHidden) {
            itemStack = this.a(string, f10, f11, f12);
            f10 = itemStack.x;
            f11 = itemStack.y;
            f12 = itemStack.z;
            double d10 = itemStack.w;
    ...
    void a(BufferBuilder bufferBuilder, GeoBone geoBone, boolean bl2) {
        ...
        GlStateManager.func_179147_l();
        GlStateManager.func_187401_a((GlStateManager.SourceFactor)GlStateManager.SourceFactor.SRC_ALPHA, (GlStateManager.DestFactor)GlStateManager.DestFactor.ONE_MINUS_SRC_ALPHA);
        ItemStack itemStack = bl2 ? this.x : this.s;
        ...
        if (this.u && !bl2 && itemStack.func_77973_b() instanceof ItemBow) {
            this.t += 0.015f;
    ...
    protected void a(boolean bl2, ItemStack itemStack) {
        GlStateManager.func_179114_b((float)(bl2 ? 200.0f : 90.0f), (float)1.0f, (float)0.0f, (float)0.0f);
    }
